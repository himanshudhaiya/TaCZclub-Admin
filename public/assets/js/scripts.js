...
// sidebar active class js start

// $("a.dash-link").click(function () {
//   $("a.dash-link").css("background-color", "#ffff");
//   $(this).css("background-color", "#6fd943");
// });

function activeSideBar(name) {
  $("#" + name).addClass("sideMenu-li-active");
}
// sidebar active class js end
