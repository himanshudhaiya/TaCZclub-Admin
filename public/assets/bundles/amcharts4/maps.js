  ...
  ["cc1e"],
  {
              ...
              set: function (t) {
                ...
                this._chart.set(
                  ...
                  new s.c([
                    ...
                    Object(l.b)().body.events.on(
                      "keyup",
                      function (i) {
                        e.topParent.hasFocused &&
                          (u.b.isKey(i.event, "enter")
                            ? e.minusButton.isFocused
                              ? t.zoomOut()
                              : e.plusButton.isFocused && t.zoomIn()
                            : u.b.isKey(i.event, "plus")
                            ? t.zoomIn()
                            : u.b.isKey(i.event, "minus") && t.zoomOut());
                      },
                      t
                    ),
            ...
            (e.prototype.updateThumb = function () {
              ...
              if (!i.isDown) {
                ...
                "vertical" == this.layout
                  ? (i.y =
                      t.pixelHeight -
                      ((t.pixelHeight - i.pixelHeight) * o) / this.stepCount -
                      i.pixelHeight)
                  : (i.x = (t.pixelWidth * o) / this.stepCount);
              }
            }),
            (e.prototype.handleThumbDrag = function () {
              ...
              t =
                ...
                (t =
                  "vertical" == this.layout
                    ? (this.stepCount *
                        (e.pixelHeight - o.pixelY - o.pixelHeight)) /
                      (e.pixelHeight - o.pixelHeight)
                    : (this.stepCount * o.pixelX) / e.pixelWidth);
              var n = Math.pow(2, t);
    ...
    QJ7E: function (t, e, i) {
        ...
        m = (function (t) {
          ...
          return (
            ...
            (e.prototype.validatePosition = function () {
              g.isNumber(this.latitude) &&
                g.isNumber(this.longitude) &&
                this.moveTo(
                  this.series.chart.projection.convert({
      ...
      var f = i("R6wv"),
        ...
        v = (function (t) {
          function e() {
            ...
            var i = new y.a();
            return (
              (e.fill = i.getFor("secondaryButton")),
          ...
          return (
            ...
            (e.prototype.validate = function () {
              this.series &&
                (this.polygon.points =
                  this.series.chart.projection.projectGeoArea(
                    this.multiGeoPolygon
                  )),
                t.prototype.validate.call(this);
            }),
      ...
      var j = (function () {
        ...
        return (
          (t.prototype.projectGeoArea = function (t) {
          ...
          (t.prototype.getClipRectangle1 = function () {
            ...
            return [
              { longitude: -180, latitude: e - 90 },
              { longitude: t - 1e-5, latitude: e - 90 },
              { longitude: t - 1e-5, latitude: e + 90 },
              { longitude: -180, latitude: e + 90 },
            ];
          }),
          ...
          (t.prototype.getRect1 = function () {
            var t = L(180 - this.deltaLongitude),
              e = L(this.deltaLatitude);
            return { north: e + 90, south: e - 90, west: t - 180, east: t };
          }),
          (t.prototype.getRect2 = function () {
            var t = L(180 - this.deltaLongitude),
              e = L(this.deltaLatitude);
            return { north: e + 90, south: e - 90, west: t, east: t + 180 };
          }),
          (t.prototype.clipGeoLine = function (t) {
            if (t) {
              for (
                var e = [],
                  i = this.getClipRectangle1(),
                  o = this.getClipRectangle2(),
                  n = 0,
                  r = t.length;
                n < r;
                n++
                ...
                if (a) {
                  ...
                  if (((e = e.concat(s)), 0 != this.deltaLongitude)) {
            ...
            if (t) {
              for (
                var e,
                  i,
                  o = [],
                  n = this.getClipRectangle1(),
                  r = this.getClipRectangle2(),
                  a = this.getRect1(),
                  s = this.getRect2(),
                  l = 0,
                  h = t.length;
          ...
          (t.prototype.convertGeoArea = function (t) {
            if (t) {
              for (var e = [], i = 0, o = t.length; i < o; i++) {
                ...
                if (r) {
                  for (var p = [], c = ((u = 0), r.length); u < c; u++) {
                    h = this.convert(r[u]);
                    p.push(h);
                  }
                  a.push(p);
          ...
          (t.prototype.convert = function (t) {
            ...
            var e = this.project(
              t.longitude * b.RADIANS,
              t.latitude * b.RADIANS
            );
            return {
          ...
          (t.prototype.invert = function (t) {
            var e = this.unproject(
                (t.x / this.scale + this.centerPoint.x) * b.RADIANS,
                (-t.y / this.scale - this.centerPoint.y) * b.RADIANS
              ),
              i = {
                longitude: e.longitude * b.DEGREES,
                latitude: e.latitude * b.DEGREES,
              };
            return (i = this.unrotate(
              i,
              this.deltaLongitude,
              this.deltaLatitude,
              this.deltaGama
          ...
          (t.prototype.clipLine = function (t, e) {
            if (t && 0 != t.length) {
              var i,
                ...
                a = function (t) {
                  return (
                    (o.longitude - i.longitude) * (t.latitude - i.latitude) >
                    (o.latitude - i.latitude) * (t.longitude - i.longitude)
                  );
                },
                s = function () {
          ...
          (t.prototype.getExtremes = function (t) {
            ...
            return { north: o, east: i, south: n, west: e };
          }),
          ...
          (t.prototype.intermediatePoint = function (t, e, i) {
            var o = t.latitude * b.RADIANS,
              ...
              y =
                ...
                Math.cos(o) * Math.cos(r) * Math.sin(f / 2) * Math.sin(f / 2),
              ...
              C = Math.atan2(x, L);
            return { latitude: S * b.DEGREES, longitude: C * b.DEGREES };
          }),
          t
        );
      })();
          ...
          return (
            ...
            (e.prototype.handleAllInited = function () {
              ...
              (this.seriesContainer.visible = !0),
                ...
                t
                  ? (this.updateExtremes(), this.goHome(0))
                  : c.b.events.once(
                      "exitframe",
            ...
            (e.prototype.handleDrag = function () {
              var t = this.seriesWidth * this.zoomLevel * this.scaleRatio,
                ...
                n = this.maxPanOut,
                r = Math.min(this.maxWidth * (1 - n) - t / 2, -t * (n - 0.5));
              i < r && (i = r);
              var a = Math.max(
                this.maxWidth * n + t / 2,
                this.maxWidth + t * (n - 0.5)
              );
              i > a && (i = a);
              var s = Math.min(
                this.maxHeight * (1 - n) - e / 2,
                -e * (n - 0.5)
              );
              o < s && (o = s);
              var u = Math.max(
                this.maxHeight * n + e / 2,
                this.maxHeight + e * (n - 0.5)
              );
              o > u && (o = u),
                this.seriesContainer.moveTo({ x: i, y: o }, void 0, void 0, !0),
              ...
              if (
                (I.each(this.series.iterator(), function (e) {
                  (t.west > e.west || !g.isNumber(t.west)) && (t.west = e.west),
                    (t.east < e.east || !g.isNumber(t.east)) &&
                      (t.east = e.east),
                    (t.north < e.north || !g.isNumber(t.north)) &&
                      (t.north = e.north),
                    (t.south > e.south || !g.isNumber(t.south)) &&
                      (t.south = e.south);
                }),
                ...
                var p = void 0,
                  ...
                  m = r.innerWidth / c,
                  f = r.innerHeight / d;
                (p = m > f ? f : m), (g.isNaN(p) || p == 1 / 0) && (p = 1);
                var y = !1;
                this.projection.scale != p &&
                  ((this.projection.scale = p), (y = !0)),
            ...
            (e.prototype.updateScaleRatio = function () {
              var t,
                e = this.chartContainer.innerWidth / this.seriesWidth,
                i = this.chartContainer.innerHeight / this.seriesHeight;
              (t = e > i ? i : e),
                (g.isNaN(t) || t == 1 / 0) && (t = 1),
                t != this.scaleRatio &&
                  ((this.scaleRatio = t),
            ...
            (e.prototype.zoomToGeoPoint = function (t, e, i, o) {
              ...
              if ((t || (t = this.zoomGeoPoint), t)) {
                ...
                return (
                  i && (s = { x: this.maxWidth / 2, y: this.maxHeight / 2 }),
            ...
            (e.prototype.zoomToMapObject = function (t, e, i, o) {
              if ((void 0 == i && (i = !0), t instanceof m))
                return (
                  g.isNaN(e) && (e = 5),
                  this.zoomToGeoPoint(
              ...
              var n = t.dataItem;
              if (
                (n && g.isNumber(n.zoomLevel) && (e = n.zoomLevel),
                t instanceof v)
              ) {
                var r = t.dataItem,
                  a = t.polygon.bbox;
                g.isNumber(e) ||
                  (e = Math.min(
                    this.seriesWidth / a.width,
                    this.seriesHeight / a.height
                  ));
                var s = void 0;
                if (r && g.hasValue(r.zoomGeoPoint)) s = r.zoomGeoPoint;
                else {
                  var u = { x: a.x + a.width / 2, y: a.y + a.height / 2 },
            ...
            (e.prototype.zoomToRectangle = function (t, e, i, o, n, r, a) {
              ...
              var s =
                n *
                Math.min(
                  (this.south - this.north) / (i - t),
                  (this.west - this.east) / (o - e)
                );
              return this.zoomToGeoPoint(
                { latitude: t + (i - t) / 2, longitude: o + (e - o) / 2 },
                s,
                r,
                a
              );
            ...
            Object.defineProperty(e.prototype, "deltaLongitude", {
              ...
              set: function (t) {
                this.setPropertyValue("deltaLongitude", L(t)) &&
                  this.invalidateProjection();
              },
              enumerable: !0,
              configurable: !0,
            ...
            (e.prototype.configOrder = function (e, i) {
              return e == i
                ...
                : "series" == i
                ? -1
                : t.prototype.configOrder.call(this, e, i);
            }),
      ...
      c.b.registeredClasses.MapLineObject = z;
      var D = i("Rnbi"),
        R = i("vMqJ"),
        A = i("jfaP"),
        N = i("8ZqG"),
          ...
          return (
            ...
            Object.defineProperty(e.prototype, "imagesToConnect", {
              ...
              set: function (t) {
                for (var e = this, i = 0, o = t.length; i < o; i++) {
                  var n = t[i];
                  if (g.isString(n)) {
                    if (!this.map.hasKey(n)) continue;
                    (n = this.map.getKey(n)), (t[i] = n);
                  }
                  n.events.on(
                    "propertychanged",
                    function (t) {
            ...
            (e.prototype.validate = function () {
              ...
              if (this.imagesToConnect) {
                ...
                try {
                  for (
                    var a = u.g(this.imagesToConnect), s = a.next();
                    !s.done;
                    s = a.next()
                  ) {
                    var l = s.value;
                    r.push({ longitude: l.longitude, latitude: l.latitude });
                  }
                } catch (t) {
                  e = { error: t };
                } finally {
                    ...
                    for (
                      var y = d[m - 1],
                        ...
                        b =
                          4 *
                          Math.max(
                            Math.abs(y.latitude - v.latitude),
                            Math.abs(y.longitude - v.longitude)
                          ),
                        P = 0;
                      P < b;
                      P++
                      ...
                      if (g.length > 0) {
                        var L = g[g.length - 1];
                        Math.abs(L.longitude - M.longitude) > 359 &&
                          (h.push(g), (g = []));
                      }
                      g.push(M);
                    }
            ...
            Object.defineProperty(e.prototype, "lineObjects", {
              get: function () {
                return (
                  this._lineObjects ||
                    ((this._lineObjects = new R.e(new z())),
            ...
            (e.prototype.handleLineObjectAdded = function (t) {
              var e = t.newValue;
              (e.mapLine = this), (e.parent = this);
            }),
            Object.defineProperty(e.prototype, "arrow", {
              get: function () {
                if (!this._arrow) {
                  var t = this.createChild(z);
                  (t.shouldClone = !1),
                    (t.width = 8),
                    (t.height = 10),
                    (t.mapLine = this),
                    (t.position = 0.5);
                  var e = t.createChild(D.a);
                  (e.fillOpacity = 1),
      ...
      c.b.registeredClasses.MapLine = V;
      var W = i("xgTw"),
        H = (function (t) {
          function e() {
            var e = t.call(this) || this;
      ...
      c.b.registeredClasses.MapSpline = H;
      var k = i("MXvJ"),
        F = (function (t) {
          function e() {
            var e = t.call(this) || this;
      ...
      function B(t) {
        for (var e = [], i = 0, o = t.length; i < o; i++) {
          var n = t[i][0],
            r = t[i][1];
          (e[i] = []), n && e[i].push(q(n)), r && e[i].push(q(r));
        }
        return e;
      }
      function Z(t) {
        for (var e = [], i = 0, o = t.length; i < o; i++) e.push(q(t[i]));
        return e;
      }
      function q(t) {
        for (var e = [], i = 0, o = t.length; i < o; i++) e.push(X(t[i]));
        return e;
      }
      function X(t) {
        ...
        K = (function (t) {
          ...
          return (
            ...
            Object.defineProperty(e.prototype, "polygon", {
              ...
              set: function (t) {
                (this._polygon = t), (this.multiGeoPolygon = B([t]));
              },
              enumerable: !0,
              configurable: !0,
            }),
            Object.defineProperty(e.prototype, "multiPolygon", {
              ...
              set: function (t) {
                (this._multiPolygon = t), (this.multiGeoPolygon = B(t));
              },
              enumerable: !0,
              configurable: !0,
            }),
          ...
          return (
            ...
            (e.prototype.validateData = function () {
              ...
              if (
                ...
                if ((this.geodata && (i = this.geodata), i)) {
                  var o = void 0;
                  if (
                      ...
                      var n = function (t, e) {
                          ...
                          if (n) {
                            ...
                            if ("Polygon" == a || "MultiPolygon" == a) {
                              ...
                              l
                                ? l.multiPolygon || (l.multiPolygon = u)
                                : ((l = { multiPolygon: u, id: s }),
                                  r.data.push(l)),
      ...
      var Q = (function (t) {
          ...
          return (
            ...
            Object.defineProperty(e.prototype, "line", {
              ...
              set: function (t) {
                (this._line = t), (this.multiGeoLine = Z([t]));
              },
              enumerable: !0,
              configurable: !0,
            }),
            Object.defineProperty(e.prototype, "multiLine", {
              ...
              set: function (t) {
                (this._multiLine = t), (this.multiGeoLine = Z(t));
              },
              enumerable: !0,
              configurable: !0,
            }),
            Object.defineProperty(e.prototype, "geoLine", {
              ...
              set: function (t) {
                (this._geoLine = t), (this.multiGeoLine = [t]);
              },
              enumerable: !0,
              configurable: !0,
            }),
        ...
        $ = (function (t) {
          ...
          return (
            ...
            (e.prototype.validateData = function () {
              var e = this;
              if (
                (this.data.length > 0 && this.mapLines.clear(),
                this.useGeodata || this.geodata)
              ) {
                      ...
                      var n = function (t, e) {
                          ...
                          if (n) {
                            ...
                            if ("LineString" == a || "MultiLineString" == a) {
                              ...
                              l
                                ? l.multiLineString || (l.multiLineString = u)
                                : ((l = { multiLineString: u, id: s }),
                                  r.data.push(l)),
                                O.softCopyProperties(i.properties, l);
                            }
                          }
      ...
      var it = (function (t) {
          ...
          return (
            ...
            Object.defineProperty(e.prototype, "point", {
              ...
              set: function (t) {
                (this._point = t), (this.geoPoint = X(t));
              },
              enumerable: !0,
              configurable: !0,
            }),
        ...
        ot = (function (t) {
          ...
          return (
            ...
            (e.prototype.validateData = function () {
              var e = this;
              if (
                (this.data.length > 0 && this.mapImages.clear(),
        ...
        st = (function (t) {
          ...
          return (
            ...
            (e.prototype.project = function (t, e) {
              return { x: t, y: Math.log(Math.tan((Math.PI / 2 + e) / 2)) };
            }),
            e
          );
        })(j);
      ...
      var ut = (function (t) {
        ...
        return (
          ...
          (e.prototype.unproject = function (t, e) {
            return {
              longitude: t,
              latitude: 2.5 * Math.atan(Math.exp(0.8 * e)) - 0.625 * Math.PI,
            };
          }),
          (e.prototype.project = function (t, e) {
            return {
              x: t,
              y: 1.25 * Math.log(Math.tan(Math.PI / 4 + 0.4 * e)),
            };
          }),
          e
        );
      ...
      var lt = (function (t) {
        ...
        return (
          ...
          (e.prototype.project = function (t, e) {
            for (
              var i = (1 + Math.PI / 2) * Math.sin(e), o = 0, n = 1 / 0;
              o < 10 && Math.abs(n) > 1e-5;
              o++
            )
              e -= n = (e + Math.sin(e) - i) / (1 + Math.cos(e));
            return (
              (i = Math.sqrt(2 + Math.PI)),
              { x: (t * (1 + Math.cos(e))) / i, y: (2 * e) / i }
            );
          }),
          e
        );
      ...
      var ht = (function (t) {
        ...
        return (
          ...
          (e.prototype.getClipRectangle2 = function () {
            var t,
              e = 90 - this.deltaLongitude,
              i = -this.deltaLatitude;
            return [
              {
                longitude: 1e-5 + e - 180 + (t = e > 0 ? -360 : 360),
                latitude: i - 90,
              },
              { longitude: e - 1e-5 + t, latitude: i - 90 },
              { longitude: e - 1e-5 + t, latitude: i + 90 },
              { longitude: 1e-5 + e - 180 + t, latitude: i + 90 },
            ];
          }),
                      ...
                      if (_ > 1) {
                        for (var w = 1; w < _; w++)
                          O.push({
                            ...
                            latitude:
                              j.latitude + ((C.latitude - j.latitude) / _) * w,
                          });
                        p.splice.apply(p, u.f([S, 0], O)), (S += O.length);
                      }
                    }
                    j = C;
                  }
      ...
      (c.b.registeredClasses.Orthographic = ht), (window.am4maps = r);
    },
    q7lS: function (t, e, i) {
      "use strict";
      i.d(e, "a", function () {
          ...
          return (
            ...
            (e.prototype.moveToPosition = function (t) {
              var e = t.svgPoint,
                ...
                s = this.chart.svgPointToGeo({ x: r, y: a });
            ...
            (e.prototype.updateRectangle = function () {
              ...
              var o = Math.min(this.percentWidth, this.percentHeight) / 100,
                n = t.seriesContainer;
              (i.x = Math.ceil(
                (((e * n.pixelWidth) / 2 - n.pixelX) * o) / e + i.pixelWidth / 2
              )),
                (i.y = Math.ceil(
                  (((e * n.pixelHeight) / 2 - n.pixelY) * o) / e +
                    i.pixelHeight / 2
                )),
                i.validate();
            }),
