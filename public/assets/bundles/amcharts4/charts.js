    ...
    XFs4: function (e, t, i) {
            ...
            (t.prototype.processConfig = function (t) {
              if (t) {
                ...
                if (!f.hasValue(t.dataFields) || !f.isObject(t.dataFields))
                  throw Error(
                    "`dataFields` is not set for series [" + this.name + "]"
                  );
              }
      ...
      var E = i("BEgH"),
        ...
        H = (function (e) {
          function t() {
            var t = e.call(this) || this;
            (t._chart = new _.d()), (t.className = "XYChartScrollbar");
            var i = new B.a();
            t.padding(0, 0, 0, 0);
            ...
            (t.prototype.validate = function () {
              ...
              (this._startLocation = o + (s / n) * (l - o)),
                ...
                this.dataItems.each(function (e) {
                  (e.index < i.startIndex || e.index >= i.endIndex) &&
                    i.disableUnusedColumns(e);
                });
            }),
            (t.prototype.validateDataElement = function (t) {
