        ...
        var n = function (e, t) {
          ...
          if (
            ("string" == typeof e
              ...
              : (r.element =
                  "undefined" != typeof e.length && e.length > 0 ? e[0] : e),
            !r.element)
          )
            throw new Error("[cleave.js] Please check the element");
          (t.initValue = r.element.value),
            (r.properties = n.DefaultProperties.assign({}, t)),
            r.init();
        };
        (n.prototype = {
          init: function () {
            ...
            return t.numeral ||
              ...
              0 !== t.blocksLength ||
              t.prefix
              ? ((t.maxLength = n.Util.getMaxLength(t.blocks)),
          ...
          initNumeralFormatter: function () {
            var e = this,
              t = e.properties;
            t.numeral &&
              (t.numeralFormatter = new n.NumeralFormatter(
          ...
          initDateFormatter: function () {
            var e = this,
              t = e.properties;
            t.date &&
              ((t.dateFormatter = new n.DateFormatter(t.datePattern)),
          ...
          initPhoneFormatter: function () {
            ...
            if (t.phone)
              try {
                t.phoneFormatter = new n.PhoneFormatter(
          ...
          onKeyDown: function (e) {
            var t = this,
              ...
              o = t.element.value;
            return (
              a.isAndroidBackspaceKeydown(t.lastInputValue, o) && (i = 8),
              (t.lastInputValue = o),
              8 === i &&
              a.isDelimiter(
                o.slice(-r.delimiterLength),
                r.delimiter,
                r.delimiters
              )
                ? void (r.backspace = !0)
          ...
          copyClipboardData: function (e) {
            ...
            o = r.copyDelimiter
              ? a
              : i.stripDelimiters(a, r.delimiter, r.delimiters);
            try {
              e.clipboardData
          ...
          onInput: function (e) {
            ...
            return (
              r.numeral ||
                !r.backspace ||
                i.isDelimiter(
                  e.slice(-r.delimiterLength),
                  r.delimiter,
                  r.delimiters
                ) ||
                (e = i.headStr(e, e.length - r.delimiterLength)),
              r.phone
                ...
                : (r.date && (e = r.dateFormatter.getValidatedDate(e)),
                  (e = i.stripDelimiters(e, r.delimiter, r.delimiters)),
                  (e = i.getPrefixStrippedValue(e, r.prefix, r.prefixLength)),
                  (e = r.numericOnly ? i.strip(e, /[^\d]/g) : e),
                  ...
                  ((e = r.prefix + e), 0 !== r.blocksLength)
                    ? (r.creditCard && t.updateCreditCardPropsByValue(e),
                      (e = i.headStr(e, r.maxLength)),
                      (r.result = i.getFormattedValue(
                        e,
                        r.blocks,
                        r.blocksLength,
                        r.delimiter,
          ...
          updateCreditCardPropsByValue: function (e) {
            var t,
              ...
              i = r.properties,
              a = n.Util;
            a.headStr(i.result, 4) !== a.headStr(e, 4) &&
              ((t = n.CreditCardDetector.getInfo(e, i.creditCardStrictMode)),
              (i.blocks = t.blocks),
              (i.blocksLength = i.blocks.length),
              (i.maxLength = a.getMaxLength(i.blocks)),
              i.creditCardType !== t.type &&
                ((i.creditCardType = t.type),
                i.onCreditCardTypeChanged.call(r, i.creditCardType)));
          },
          ...
          getRawValue: function () {
            ...
            return (
              t.rawValueTrimPrefix &&
                (i = r.getPrefixStrippedValue(i, t.prefix, t.prefixLength)),
              (i = t.numeral
                ? t.numeralFormatter.getRawValue(i)
                : r.stripDelimiters(i, t.delimiter, t.delimiters))
            );
          },
          ...
          (n.NumeralFormatter = r(1)),
          (n.DateFormatter = r(2)),
          (n.PhoneFormatter = r(3)),
          (n.CreditCardDetector = r(4)),
          (n.Util = r(5)),
          (n.DefaultProperties = r(6)),
    ...
    function (e, t) {
      ...
      var r = function (e, t, n, i, a, o, l) {
        ...
        (s.numeralDecimalMark = e || "."),
          ...
          (s.numeralDecimalScale = n >= 0 ? n : 2),
          (s.numeralThousandsGroupStyle = i || r.groupStyle.thousand),
          ...
          format: function (e) {
            ...
            switch (
              ...
              e.indexOf(i.numeralDecimalMark) >= 0 &&
                ((t = e.split(i.numeralDecimalMark)),
                (n = t[0]),
                (a =
            ...
            return (
              n.toString() + (i.numeralDecimalScale > 0 ? a.toString() : "")
            );
          },
        }),
        (e.exports = r);
    ...
    function (e, t) {
      ...
      (r.prototype = {
        ...
        format: function (e) {
          ...
          for (var r, n = "", i = !1, a = 0, o = e.length; a < o; a++)
            (r = t.formatter.inputDigit(e.charAt(a))),
              /[\s()-]/g.test(r) ? ((n = r), (i = !0)) : i || (n = r);
          return (
            (n = n.replace(/[()]/g, "")), (n = n.replace(/[\s-]/g, t.delimiter))
          );
        },
      }),
        (e.exports = r);
