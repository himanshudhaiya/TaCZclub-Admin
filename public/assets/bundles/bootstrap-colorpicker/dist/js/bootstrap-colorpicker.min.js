...
!(function (t, e) {
  "object" == typeof exports && "object" == typeof module
    ...
    ? define("bootstrap-colorpicker", ["jQuery"], e)
    : "object" == typeof exports
    ? (exports["bootstrap-colorpicker"] = e(require("jQuery")))
    : (t["bootstrap-colorpicker"] = e(t.jQuery));
})(this, function (t) {
  return (function (t) {
    function e(r) {
        ...
        a = (function () {
          function t(e) {
            ...
            this.colorpicker.element.on(
              ...
              s.default.proxy(this.onCreate, this)
            ),
              this.colorpicker.element.on(
                "colorpickerDestroy.colorpicker-ext",
                s.default.proxy(this.onDestroy, this)
              ),
              this.colorpicker.element.on(
                "colorpickerUpdate.colorpicker-ext",
                s.default.proxy(this.onUpdate, this)
              ),
              this.colorpicker.element.on(
                "colorpickerChange.colorpicker-ext",
                s.default.proxy(this.onChange, this)
              ),
              this.colorpicker.element.on(
                "colorpickerInvalid.colorpicker-ext",
                s.default.proxy(this.onInvalid, this)
              ),
              this.colorpicker.element.on(
                "colorpickerShow.colorpicker-ext",
                s.default.proxy(this.onShow, this)
              ),
              this.colorpicker.element.on(
                "colorpickerHide.colorpicker-ext",
                s.default.proxy(this.onHide, this)
              ),
              this.colorpicker.element.on(
                "colorpickerEnable.colorpicker-ext",
                s.default.proxy(this.onEnable, this)
              ),
              this.colorpicker.element.on(
                "colorpickerDisable.colorpicker-ext",
                s.default.proxy(this.onDisable, this)
              );
          }
          return (
            i(t, [
      ...
      var s =
        ...
        h = (function (t) {
          function e(t) {
            ...
            return (
              Array.isArray(n.options.colors) ||
                "object" === s(n.options.colors) ||
                (n.options.colors = null),
              n
            );
          }
          return (
              ...
              },
              {
                ...
                value: function (t) {
                  return (
                    !(this.getLength() <= 0) &&
                    (Array.isArray(this.options.colors)
                      ? this.options.colors.indexOf(t) >= 0
                        ? t
                        : this.options.colors.indexOf(t.toUpperCase()) >= 0
                        ? t.toUpperCase()
                        : this.options.colors.indexOf(t.toLowerCase()) >= 0 &&
                          t.toLowerCase()
                      : "object" === s(this.options.colors) &&
                        (this.options.namesAsValues
                          ? this.getName(
                              t,
                              this.getName("#" + t, this.getValue(t, !1))
                            )
                          : this.getValue(t, !1)))
                  );
                },
                ...
                value: function (t) {
                  ...
                  for (var o in this.options.colors)
                    if (
                      ...
                      this.options.colors[o].toLowerCase() === t.toLowerCase()
                    )
                      return o;
                  return e;
                },
              },
              {
                ...
                value: function (t) {
                  ...
                  return "string" == typeof t &&
                    this.options.colors &&
                    this.options.colors.hasOwnProperty(t)
    ...
    function (t, e, o) {
      ...
      var i =
        ...
        l = r(a),
        c = "colorpicker";
      (l.default[c] = s.default),
        (l.default.fn[c] = function (t) {
          var e = Array.prototype.slice.call(arguments, 1),
            ...
            n = this.each(function () {
              ...
              n || ((n = new s.default(this, a)), o.data(c, n)),
                "string" == typeof t
                  ? "colorpicker" === t
                    ? (r = n)
                    : l.default.isFunction(n[t])
                    ? (r = n[t].apply(n, e))
                    : (e.length && (n[t] = e[0]), (r = n[t]))
                  : (r = o);
            });
          return o ? r : n;
        }),
        ...
        b = (function () {
          function t(e, o) {
            ...
            i(this, t),
              (v += 1),
              (this.id = v),
              (this.element = (0, g.default)(e).addClass(
                "colorpicker-element"
              )),
              ...
              (this.container =
                !1 !== this.container && (0, g.default)(this.container)),
              (this.currentSlider = null),
              (this.mousePointer = { left: 0, top: 0 }),
              (this.lastEvent = { name: null, e: null }),
              ...
              this.options.extensions.forEach(function (t) {
                r.addExtension(t.name, p.default[t.name.toLowerCase()], t);
              });
            var n =
              !1 !== this.options.color ? this.options.color : this.getValue();
            (this.color = !!n && this.createColor(n)),
              !1 === this.options.format &&
                (this.options.format = this.color.format),
              (this.disabled = !1);
            var s = (this.picker = (0, g.default)(this.options.template));
            this.options.customClass && s.addClass(this.options.customClass),
              this.options.inline
                ? s.addClass("colorpicker-inline colorpicker-visible")
                : s.addClass("colorpicker-hidden"),
              this.options.horizontal && s.addClass("colorpicker-horizontal"),
              (this.options.useAlpha ||
                (this.hasColor() && this.color.hasTransparency())) &&
                !1 !== this.options.useAlpha &&
                ((this.options.useAlpha = !0),
                s.addClass("colorpicker-with-alpha")),
              "right" === this.options.align && s.addClass("colorpicker-right"),
              !0 === this.options.inline && s.addClass("colorpicker-no-arrow"),
              s.on(
                "mousedown.colorpicker touchstart.colorpicker",
                g.default.proxy(function (t) {
              ...
              s
                ...
                .on(
                  "mousedown.colorpicker touchstart.colorpicker",
                  g.default.proxy(this._mousedown, this)
                ),
              s.appendTo(
                this.container ? this.container : (0, g.default)("body")
              ),
              this.hasInput() &&
                (this.input.on({
                  "keyup.colorpicker": g.default.proxy(this._keyup, this),
                }),
                this.input.on({
                  "change.colorpicker": g.default.proxy(this._change, this),
                }),
                !1 === this.component &&
                  this.element.on({
                ...
                !1 === this.options.inline &&
                  this.element.on({
                    "focusout.colorpicker": g.default.proxy(this.hide, this),
                  })),
              !1 !== this.component &&
                this.component.on({
              ...
              this.update(!1 !== this.options.color),
              (0, g.default)(
                g.default.proxy(function () {
            ...
            n(t, [
              ...
              },
              {
                ...
                value: function () {
                  ...
                  return t
                    ? (!1 === this.options.useHashPrefix &&
                        (t = t.replace(/^#/g, "")),
                      this._resolveColor(t))
                    : t;
                },
              },
              {
              ...
              },
              {
                ...
                value: function (t) {
                  if (
                    ...
                    (this.lastEvent.e = t),
                    !1 !== this.options.inline || this.options.container)
                  )
                    return !1;
                  var e =
                      this.container &&
                  ...
                  return (
                    "right" === this.options.align &&
                      (r.left -= this.picker.outerWidth() - o.outerWidth()),
                    this.picker.css({
                ...
                value: function (t) {
                  return (
                    ...
                    !this.isVisible() &&
                      ...
                      this._reposition(t),
                      (0, g.default)(window).on(
                        "resize.colorpicker",
                        g.default.proxy(this._reposition, this)
                      ),
                      !t ||
                        (this.hasInput() &&
                          "color" !== this.input.attr("type")) ||
                      ...
                      (!this.component && this.input) ||
                        ...
                        (0, g.default)(window.document).on({
                          "mousedown.colorpicker": g.default.proxy(
                            this.hide,
                            this
                          ),
                        }),
                  ...
                  return (
                    ...
                    !this.isHidden() &&
                      (void 0 === t ||
                        !t.target ||
                        !(
                          (0, g.default)(t.currentTarget).parents(
                            ".colorpicker"
                          ).length > 0 ||
                          (0, g.default)(t.target).parents(".colorpicker")
                            .length > 0
                        )) &&
                      (this.picker
                      ...
                      (0, g.default)(window.document).off({
              ...
              },
              {
                ...
                value: function () {
                  return (
                    this.picker.hasClass("colorpicker-visible") &&
                ...
                value: function () {
                  if (this.hasColor()) {
                    ...
                    r.length &&
                      r.css(
                        t ? "top" : "left",
                        (t ? e.hue.maxTop : e.hue.maxLeft) * (1 - n.h)
                      ),
                      i.length &&
                        i.css(
                          t ? "top" : "left",
                          (t ? e.alpha.maxTop : e.alpha.maxLeft) * (1 - n.a)
                        ),
                      o.length &&
                        o.css({
                      ...
                      this.picker
                        ...
                        .css(
                          "backgroundColor",
                          this.color.getHueOnlyCopy().toHexString()
                        ),
                      this.picker
                        .find(".colorpicker-alpha")
                        .css("backgroundColor", this.color.toString("hex6"));
                  }
                },
              },
              {
                ...
                value: function () {
                  if (this.hasColor() && !1 !== this.component) {
                    ...
                    t.length > 0
                      ? t.css({ backgroundColor: this.toCssColorString() })
                      : this.component.css({
              ...
              },
              {
                ...
                value: function () {
                  ...
                  if (this._shouldUpdate() || !0 === t) {
                    ...
                    (!0 !== this.options.autoInputFallback &&
                      "keyup" === this.lastEvent.name) ||
                      this._updateInput(),
                      this._updatePicker(),
                      this.element.trigger({
              ...
              },
              {
                ...
                value: function () {
                  ...
                  return (
                    this.hasInput() &&
                      (e.push(this.input.val()),
                      e.push(this.input.data("color"))),
                    e.push(this.element.data("color")),
                    e.map(function (t) {
                      t && !1 === o && (o = t);
                    }),
                    (o = !1 === o ? t : o),
                    o instanceof a.default ? o.toString(this.format) : o
                  );
                },
              },
              {
              ...
              },
              {
                ...
                value: function (t) {
                  var e =
                      !(arguments.length > 1 && void 0 !== arguments[1]) ||
                      arguments[1],
                    o = new a.default(this._resolveColor(t), {
                      format: this.format,
                    });
                  if (!o.isValid()) {
                    var r = o,
                    ...
                    if (
                      e &&
                      ((i =
                        this.fallbackColor instanceof a.default &&
                        this.fallbackColor.isValid()
                          ? this.fallbackColor
                          : this._resolveColor(this.fallbackColor)),
                      (o = new a.default(i, { format: this.format })),
                      !o.isValid() && e)
                    )
                  ...
                  return (
                    0 === n.s && 0 === n.h && 0 !== s.h && o.setHueRatio(s.h),
                    !this.isAlphaEnabled() &&
                      o.hasTransparency() &&
                      o.setAlpha(1),
                    o
              ...
              },
              {
                ...
                value: function (t) {
                  var e = !1;
                  return (
                    g.default.each(this.extensions, function (o, r) {
                ...
                value: function (t) {
                  ...
                  if (!o.is(".colorpicker")) {
                    if (o.is(".colorpicker-saturation"))
                      this.currentSlider = g.default.extend({}, r.saturation);
                    else if (o.is(".colorpicker-hue"))
                      this.currentSlider = g.default.extend({}, r.hue);
                    else {
                      if (!o.is(".colorpicker-alpha")) return !1;
                      this.currentSlider = g.default.extend({}, r.alpha);
                    }
                    var i = o.offset();
                    (this.currentSlider.guide =
                      o.find(".colorpicker-guide")[0].style),
                      (this.currentSlider.left = t.pageX - i.left),
                      (this.currentSlider.top = t.pageY - i.top),
                      (this.mousePointer = { left: t.pageX, top: t.pageY }),
                      (0, g.default)(window.document)
                        .on({
                          "mousemove.colorpicker": g.default.proxy(
                            this._mousemove,
                            this
                          ),
                          "touchmove.colorpicker": g.default.proxy(
                            this._mousemove,
                            this
                          ),
                          "mouseup.colorpicker": g.default.proxy(
                            this._mouseup,
                            this
                          ),
                          "touchend.colorpicker": g.default.proxy(
                            this._mouseup,
                            this
                          ),
                        })
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  var e = this.hasColor()
                    ? this.color.getCopy()
                    : this.createColor(this.fallbackColor);
                  !t.pageX &&
                    !t.pageY &&
                    t.originalEvent &&
                    t.originalEvent.touches &&
                  ...
                  var o = Math.max(
                      ...
                      Math.min(
                        ...
                        this.currentSlider.left +
                          ((t.pageX || this.mousePointer.left) -
                    ...
                    r = Math.max(
                      ...
                      Math.min(
                        ...
                        this.currentSlider.top +
                          ((t.pageY || this.mousePointer.top) -
                            this.mousePointer.top)
                      )
                    );
                  return (
                    (this.currentSlider.guide.left = o + "px"),
                    (this.currentSlider.guide.top = r + "px"),
                    this.currentSlider.callLeft &&
                      e[this.currentSlider.callLeft].call(
                        e,
                        o / this.currentSlider.maxLeft
                      ),
                    this.currentSlider.callTop &&
                      e[this.currentSlider.callTop].call(
                        e,
                        r / this.currentSlider.maxTop
                      ),
                    this.setValue(e),
                    !1
                  );
      ...
      var l = function t(e, o, r) {
        ...
        f = (function (t) {
          function e(t) {
            ...
            var n = i(
              this,
              (e.__proto__ || Object.getPrototypeOf(e)).call(this, s(t), o)
            );
            return (
              (n._originalInput = t),
              (n._hbak = n.hsva.h),
            ...
            c(e, [
              {
                ...
                value: function (t) {
                  return (
                    ...
                    this._b === t._b &&
                    this._a === t._a &&
                    this._roundA === t._roundA &&
                    this._format === t._format &&
                    this._gradientType === t._gradientType &&
                    this._ok === t._ok
                  );
                },
              },
              {
                ...
                value: function (t) {
                  ...
                  (this._originalInput = t._originalInput),
                    (this._r = t._r),
                    (this._g = t._g),
                    (this._b = t._b),
                    (this._a = t._a),
                    (this._roundA = t._roundA),
                    (this._format = a(t._format)),
                    (this._gradientType = t._gradientType),
                    (this._ok = t._ok);
                },
              },
      ...
      !(function (i) {
        ...
        function l(t, e, o) {
          ...
          if (n == s) r = i = 0;
            ...
            var l = n - s;
            switch (((i = a > 0.5 ? l / (2 - n - s) : l / (n + s)), n)) {
              case t:
                r = (e - o) / l + (e < o ? 6 : 0);
                break;
              case e:
        ...
        function c(t, e, o) {
          ...
          var i, n, s;
          if (((t = P(t, 360)), (e = P(e, 100)), (o = P(o, 100)), 0 === e))
            i = n = s = o;
          else {
        ...
        function m(t, e) {
          ...
          var o = n(t).toRgb();
          return (
            (o.r = B(0, Y(255, o.r - X((-e / 100) * 255)))),
            (o.g = B(0, Y(255, o.g - X((-e / 100) * 255)))),
            (o.b = B(0, Y(255, o.b - X((-e / 100) * 255)))),
            n(o)
          );
        }
        function k(t, e) {
        ...
        function w(t) {
          ...
          return [
            n(t),
            n({ h: (o + 120) % 360, s: e.s, l: e.l }),
            n({ h: (o + 240) % 360, s: e.s, l: e.l }),
          ];
        }
        function C(t) {
          var e = n(t).toHsl(),
          ...
          return [
            n(t),
            n({ h: (o + 90) % 360, s: e.s, l: e.l }),
            n({ h: (o + 180) % 360, s: e.s, l: e.l }),
        ...
        function O(t) {
          ...
          return [
            n(t),
            n({ h: (o + 72) % 360, s: e.s, l: e.l }),
            n({ h: (o + 216) % 360, s: e.s, l: e.l }),
          ];
        }
        function A(t, e, o) {
          (e = e || 6), (o = o || 30);
          ...
          for (r.h = (r.h - ((i * e) >> 1) + 720) % 360; --e; )
            (r.h = (r.h + i) % 360), s.push(n(r));
          return s;
        }
        function S(t, e) {
          e = e || 6;
          for (
            var o = n(t).toHsv(), r = o.h, i = o.s, s = o.v, a = [], l = 1 / e;
            e--;

          )
            a.push(n({ h: r, s: i, v: s })), (s = (s + l) % 1);
          return a;
        }
        function j(t) {
          return (
        ...
        function P(t, e) {
          ...
          var o = R(t);
          return (
            (t = Y(e, B(0, parseFloat(t)))),
            o && (t = parseInt(t * e, 10) / 100),
        ...
        function V(t) {
          ...
          return (o = G.rgb.exec(t))
            ...
            : (o = G.hex6.exec(t))
            ? { r: T(o[1]), g: T(o[2]), b: T(o[3]), format: e ? "name" : "hex" }
            : (o = G.hex4.exec(t))
            ? {
                r: T(o[1] + "" + o[1]),
                g: T(o[2] + "" + o[2]),
        ...
        (n.prototype = {
          ...
          getLuminance: function () {
            ...
            return (
              ...
              (s = o <= 0.03928 ? o / 12.92 : i.pow((o + 0.055) / 1.055, 2.4)),
              0.2126 * r + 0.7152 * n + 0.0722 * s
            );
          },
          setAlpha: function (t) {
            return (
              (this._a = j(t)), (this._roundA = X(100 * this._a) / 100), this
            );
          },
          toHsv: function () {
          ...
          toName: function () {
            return 0 === this._a
              ? "transparent"
              : !(this._a < 1) && (W[f(this._r, this._g, this._b, !0)] || !1);
          },
          toFilter: function (t) {
          ...
          toString: function (t) {
            ...
            return e ||
              ...
              ("hex" !== t &&
                ...
                "hex8" !== t &&
                "name" !== t)
              ? ("rgb" === t && (o = this.toRgbString()),
                "prgb" === t && (o = this.toPercentageRgbString()),
                ("hex" !== t && "hex6" !== t) || (o = this.toHexString()),
                "hex3" === t && (o = this.toHexString(!0)),
                "hex4" === t && (o = this.toHex8String(!0)),
                "hex8" === t && (o = this.toHex8String()),
                "name" === t && (o = this.toName()),
                "hsl" === t && (o = this.toHslString()),
                "hsv" === t && (o = this.toHsvString()),
                o || this.toHexString())
              : "name" === t && 0 === this._a
              ? this.toName()
              : this.toRgbString();
          ...
          (n.fromRatio = function (t, e) {
            if ("object" == typeof t) {
              var o = {};
              for (var r in t)
                t.hasOwnProperty(r) && (o[r] = "a" === r ? t[r] : D(t[r]));
              t = o;
            }
            return n(t, e);
          }),
          ...
          (n.readability = function (t, e) {
            var o = n(t),
              r = n(e);
            return (
              (i.max(o.getLuminance(), r.getLuminance()) + 0.05) /
              (i.min(o.getLuminance(), r.getLuminance()) + 0.05)
            );
          }),
          ...
          (n.mostReadable = function (t, e, o) {
            ...
            for (var u = 0; u < e.length; u++)
              (r = n.readability(t, e[u])) > c && ((c = r), (l = n(e[u])));
            return n.isReadable(t, l, { level: s, size: a }) || !i
              ? l
              : ((o.includeFallbackColors = !1),
                n.mostReadable(t, ["#fff", "#000"], o));
          });
        var Q = (n.names = {
            aliceblue: "f0f8ff",
            antiquewhite: "faebd7",
    ...
    function (t, e, o) {
      ...
      Object.defineProperty(e, "__esModule", { value: !0 }),
        (e.Palette = e.Swatches = e.Preview = e.Debugger = void 0);
      var i = o(9),
        n = r(i),
        s = o(10),
        a = r(s),
        ...
        u = o(2),
        h = r(u);
      (e.Debugger = n.default),
        (e.Preview = a.default),
        (e.Swatches = c.default),
        (e.Palette = h.default),
        (e.default = {
          debugger: n.default,
          preview: a.default,
      ...
      var a = (function () {
        ...
        p = (function (t) {
          function e(t) {
            ...
            return (
              (r.eventCounter = 0),
              r.colorpicker.hasInput() &&
                r.colorpicker.input.on(
                  "change.colorpicker-ext",
                  f.default.proxy(r.onChangeInput, r)
                ),
              r
            );
          }
            ...
            a(e, [
              {
                ...
                value: function (t) {
                  ...
                  var n =
                    ...
                    t +
                    "]";
                  (e = console).debug.apply(e, [n].concat(r)),
      ...
      var a = (function () {
        ...
        p = (function (t) {
          function e(t) {
            ...
            return (
              (r.element = (0, f.default)(r.options.template)),
    ...
    function (t, e, o) {
      ...
      var a = (function () {
        ...
        p = {
          barTemplate:
            '<div class="colorpicker-bar colorpicker-swatches"></div>',
                ...
                value: function (t) {
                  ...
                  if (
                    ...
                    f.default.each(this.colors, function (t, e) {
                      var s = (0, f.default)(o.options.swatchTemplate)
                      ...
                      s.on(
                        ...
                        function (t) {
                          t.preventDefault(),
                            r.setValue(
                              n
                                ? (0, f.default)(this).data("name")
                                : (0, f.default)(this).data("value")
                            );
                        }
                      ),
                        i.append(s);
