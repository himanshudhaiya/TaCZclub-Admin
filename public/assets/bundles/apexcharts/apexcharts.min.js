                  ...
                  this.isObject(t) &&
                    ...
                    Object.keys(e).forEach(function (n) {
                      i.isObject(e[n]) && n in t
                        ? (s[n] = i.extend(t[n], e[n]))
                        : Object.assign(s, a({}, n, e[n]));
                    }),
                  s
                );
              },
            ...
            value: function (t) {
              ...
              t.unfilter(!0),
                ...
                "none" !== e.config.states.normal.filter
                  ? this.applyFilter(
                      t,
                      e.config.states.normal.filter.type,
                      e.config.states.normal.filter.value
                    )
                  : e.config.chart.dropShadow.enabled &&
                    this.dropShadow(t, e.config.chart.dropShadow);
            },
          },
          {
            key: "addNormalFilter",
                ...
                t.filter(function (t) {
                  ...
                  (s = a.enabled ? e.addShadow(t, a) : t)
                    .colorMatrix(
                      "matrix",
                      [
                        0, 0, 0, 0, 0.5, 0, 0, 0, 0, 0.5, 0, 0, 0, 0, 0.5, 0, 0,
                        0, 1, 0,
                      ]
                    )
              ...
              i || (i = t.attr("pathFrom")),
                ...
                t
                  ...
                  .afterAll(function () {
                    d.isNumber(e)
                      ? e ===
                          l.globals.series[l.globals.maxValsInArrayIndex]
                            .length -
                            2 &&
            ...
            },
            {
              ...
              value: function (t) {
                var e,
                  ...
                  M = !!(
                    (L && !A.globals.resized) ||
                    (z && A.globals.dataChanged && A.globals.shouldAnimate)
                  );
                e = M ? r : o;
                ...
                return (
                  ...
                  A.globals.dataChanged &&
                    z &&
                    M &&
                    C.animatePathsGradually(n({}, Y, { speed: x })),
                  T
                );
              },
            },
              ...
              value: function (t, e, i) {
                ...
                return this.w.globals.dom.Paper.pattern(e, i, function (n) {
                  "horizontalLines" === t
                    ...
                    : "circles" === t &&
                      n.circle(e).fill("none").stroke({ color: s, width: a });
                });
              },
            },
            {
              ...
              value: function (t, e, i, s, a) {
                ...
                var g = !(
                  ...
                  f = o.globals.dom.Paper.gradient(
                    g ? "radial" : "linear",
                    function (t) {
                      t.at(l, e, s),
                        t.at(h, i, a),
          ...
          },
          {
            ...
            value: function (t, e, i) {
              ...
              if (
                ...
                (a =
                  (t.x - s.globals.minX) /
                  (s.globals.xRange / s.globals.gridWidth)),
                  (n =
                    s.globals.gridHeight -
              ...
              t.map(function (t, a) {
                if ("vertical" === t.label.orientation) {
                  ...
                  if (null !== r) {
                    ...
                    r.setAttribute(
                      "x",
                      parseInt(r.getAttribute("x")) - o.height + 4
                    ),
                      "top" === t.label.position
                        ? r.setAttribute(
                            "y",
                            parseInt(r.getAttribute("y")) + o.width
                          )
                        : r.setAttribute(
                            "y",
                            parseInt(r.getAttribute("y")) - o.width
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              var o = this.getFillColors(),
                ...
                h = Array.isArray(r.fill.opacity)
              ...
              return (
                ...
                -1 === l.indexOf("rgb")
                  ? (c = d.hexToRgba(l, h))
                  : l.indexOf("rgba") > -1 &&
                    (h = "0." + d.getOpacityFromRGBA(o[this.seriesIndex])),
                "pattern" === r.fill.type &&
                  (a = this.handlePatternFill(a, l, h, c)),
                "gradient" === r.fill.type &&
                  (n = this.handleGradientFill(n, l, h, this.seriesIndex)),
        ...
        s(t, [
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              return {
                ...
                shape:
                  i.config.markers.shape instanceof Array
                    ? i.config.markers.shape[e]
                    : i.config.markers.shape,
                class: t,
          ...
          },
          {
            ...
            value: function (t) {
              ...
              t.node.addEventListener(
                "mouseenter",
                e.pathMouseEnter.bind(this.ctx, t)
              ),
                t.node.addEventListener(
                  "mouseleave",
                  e.pathMouseLeave.bind(this.ctx, t)
                ),
                t.node.addEventListener(
                  "mousedown",
                  e.pathMouseDown.bind(this.ctx, t)
                ),
                t.node.addEventListener(
                  "touchstart",
                  e.pathMouseDown.bind(this.ctx, t),
          ...
          },
          {
            ...
            value: function (t, e, i) {
              ...
              if (
                ...
                s.globals.selectedDataPoints[e].indexOf(i) > -1
              ) {
                t.node.setAttribute("selected", !0);
                var a = s.config.states.active.filter;
                if ("none" !== a)
                  new u(this.ctx).applyFilter(t, a.type, a.value);
              }
            },
          },
          {
                ...
                for (var m = 0; m < h.x.length; m++) {
                  ...
                  if (s.globals.dataChanged)
                    if (this.dynamicAnim) {
                      ...
                      null !=
                        (z =
                          s.globals.previousPaths[l] &&
                          s.globals.previousPaths[l][e]) &&
                        ((P = z.x), (E = z.y), (T = void 0 !== z.r ? z.r : y));
                      for (var X = 0; X < s.globals.collapsedSeries.length; X++)
                        s.globals.collapsedSeries[X].index === l &&
                          ((M = 1), (y = 0));
                      0 === w && 0 === k && (y = 0),
                        a.animateCircle(
                          C,
        ...
        s(t, [
          {
            ...
            value: function (t, e, i, s, a, n, r) {
              ...
              var u = o.globals.dataLabelsRects[s].length - 2,
                g =
                  void 0 !== o.globals.lastDrawnDataLabelsIndexes[s]
                    ? o.globals.lastDrawnDataLabelsIndexes[s][
                        o.globals.lastDrawnDataLabelsIndexes[s].length - 1
                      ]
                    : 0;
              ...
              return (
                (0 === a || n) && (l = !0), { x: t, y: e, drawnextLabel: l }
              );
            },
          },
          {
              ...
              for (var c = 0; c < t.x.length; c++)
                if (
                  ...
                  if ("bubble" === s.config.chart.type)
                    ...
                    void 0 !== d &&
                      (u = s.config.dataLabels.formatter(d, {
                        seriesIndex: e,
                        dataPointIndex: l,
                        w: s,
                      }));
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (
                ...
                if (
                  (p.attr({ class: "apexcharts-datalabel", cx: s, cy: a }),
        ...
        s(t, [
                ...
                var l = function (r, l) {
                    var h,
                      ...
                      y = a.group({
                        class: "apexcharts-series ".concat(
                          s.globals.seriesNames[v].toString().replace(/ /g, "-")
                        ),
                        rel: r + 1,
                        "data:realIndex": v,
                      });
                    ...
                    for (
                      var C = a.group({ class: "apexcharts-datalabels" }),
                        L = function (e, a) {
                          void 0 === i.series[r][e] || null === t[r][e]
                            ? (i.isNullValue = !0)
                            : (i.isNullValue = !1),
                            s.config.stroke.show &&
                              (A = i.isNullValue
                                ? 0
                                : Array.isArray(i.strokeWidth)
                                ? i.strokeWidth[v]
                                : i.strokeWidth);
                          var o = null;
                          (o = i.isHorizontal
              ...
              if (this.isHorizontal)
                ...
                if (
                  ...
                  if (this.minXDiff === Number.MAX_SAFE_INTEGER) {
                    ...
                    l.globals.timelineLabels.length > 0 &&
                      (h = l.globals.timelineLabels.length),
                      h < 3 && (h = 3),
                      (this.minXDiff = (l.globals.maxX - l.globals.minX) / h);
                  }
                  n =
                    (((s = this.minXDiff / this.xRatio) / this.seriesLen) *
                      parseInt(this.barOptions.columnWidth)) /
                    100;
                }
          ...
          },
          {
            ...
            value: function (t) {
              ...
              d.globals.isXNumeric &&
                (l =
                  (d.globals.seriesX[g][p] - d.globals.minX) /
                    this.invertedXRatio -
                  i);
              ...
              if (
                ...
                m >= this.barOptions.colors.backgroundBarColors.length &&
                  (m = 0);
          ...
          },
          {
            ...
            value: function (t) {
              ...
              d.globals.isXNumeric &&
                (i =
                  (d.globals.seriesX[g][p] - d.globals.minX) / this.xRatio -
                  o / 2);
              var b = i + o * this.visibleI;
              (n = u.move(b, l)),
                (r = u.move(b, l)),
                d.globals.previousPaths.length > 0 &&
                  (r = this.getPathFrom(x, p, !0));
              var v = {
                  barWidth: o,
                  strokeWidth: h,
                  barXPosition: b,
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return (
                l < 0
                  ? (l = o.width + h)
                  : l + o.width / 2 > e.globals.gridWidth &&
                    (l = l - o.width - h),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (r.enabled && !u) {
                ...
                var g = "";
                null != s &&
                  (g = c(s, { seriesIndex: a, dataPointIndex: n, w: o })),
        ...
        s(i, [
            ...
            value: function (t, e) {
              ...
              (this.series = a.getLogSeries(t)),
                ...
                "100%" === s.config.chart.stackType &&
                  ((this.series = s.globals.seriesPercent.slice()),
                  (t = this.series)),
                (this.totalItems = 0),
                (this.prevY = []),
                (this.prevX = []),
                ...
                var o = 0,
                  ...
                  h = function (a, n) {
                    ...
                    var b,
                      ...
                      y = i.graphics.group({
                        class: "apexcharts-series ".concat(
                          s.globals.seriesNames[m].toString().replace(/ /g, "-")
                        ),
                        rel: a + 1,
                        "data:realIndex": m,
                      }),
                ...
                this.isHorizontal
                  ...
                  : ((o = i = l.globals.gridWidth / l.globals.dataPoints),
                    (o = l.globals.isXNumeric
                      ? (((i = this.minXDiff / this.xRatio) / this.seriesLen) *
                          parseInt(this.barOptions.columnWidth)) /
                        100
            ...
            value: function (t) {
              ...
              l =
                null === this.series[f][p]
                  ? e
                  : e + this.series[f][p] / this.invertedYRatio;
              var w = {
                  barHeight: s,
                  strokeWidth: a,
          ...
          },
          {
            ...
            value: function (t) {
              ...
              for (var m, b = i, v = 0, y = 0; y < this.prevYF.length; y++)
                v += this.prevYF[y][g];
              if (
              ...
              s =
                (this.series[u][g],
                m - this.series[u][g] / this.yRatio[this.yaxisIndex]);
              var k = {
                  barWidth: o,
                  strokeWidth: h,
            ...
            value: function (t, e) {
              ...
              for (var o = 0, l = 0; o < t.length; o++, l++) {
                var h,
                  ...
                  y = s.group({
                    class: "apexcharts-series ".concat(
                      i.globals.seriesNames[b].toString().replace(/ /g, "-")
                    ),
                    rel: o + 1,
                    "data:realIndex": b,
                  });
                ...
                (p = C.y),
                  ...
                  m.push(g + k / 2);
                for (
                  var L = s.group({ class: "apexcharts-datalabels" }),
                    z = 0,
        ...
        s(t, [
          {
            ...
            value: function () {
              ...
              if (t.config.xaxis.crosshairs.show) {
                "gradient" === n &&
                  (b = e.drawGradient("vertical", r, o, l, h, null, c));
                var v = e.drawRect();
                v.attr({
      ...
      return (
        s(t, [
          ...
          },
          {
            ...
            value: function (t) {
              return new Date(
                new Date(t).toUTCString().substr(0, 25)
              ).getTime();
            },
          },
          {
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              e = (e = e.replace(/(^|[^\\])ss+/g, "$1" + h(m))).replace(
                /(^|[^\\])s/g,
                "$1" + m
              );
              ...
              for (
                ...
                for (var c = 0, g = 0; g < t[o].length; g++) {
                  ...
                  if (
                    ...
                    w.node.addEventListener(
                      "mouseenter",
                      i.pathMouseEnter.bind(this, w)
                    ),
                    w.node.addEventListener(
                      "mouseleave",
                      i.pathMouseLeave.bind(this, w)
                    ),
                    w.node.addEventListener(
                      "mousedown",
                      i.pathMouseDown.bind(this, w)
                    ),
                  ...
                  if (e.globals.dataChanged) {
                    ...
                    if (this.dynamicAnim.enabled && e.globals.shouldAnimate) {
                      ...
                      S || (S = "rgba(255, 255, 255, 1)"),
                        this.animateHeatColor(w, d.rgb2hex(S), d.rgb2hex(b), A);
                    }
                  }
            ...
            value: function (t) {
              ...
              if (e.globals.dataChanged) {
                ...
                for (var p = 0; p < e.globals.previousPaths.length; p++)
                  (c =
                    (this.fullAngle * d.negToZero(e.globals.previousPaths[p])) /
                    u),
              ...
              (this.size =
                ...
                void 0 !== e.config.plotOptions.pie.size &&
                  (this.size = e.config.plotOptions.pie.size),
                (this.donutSize =
                  (this.size * parseInt(e.config.plotOptions.pie.donut.size)) /
                  100);
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              for (var g = 0; g < t.length; g++) {
                ...
                if (
                  (v.attr({ id: "apexcharts-pieSlice-" + g, index: 0, j: g }),
                ...
                if (
                  ...
                  i.config.plotOptions.pie.expandOnClick &&
                    v.click(this.pieClicked.bind(this, g)),
                  ...
                  if (0 !== x) {
                    ...
                    void 0 !== z &&
                      (L = z(i.globals.seriesPercent[g][0], {
                        seriesIndex: g,
                        w: i,
                      }));
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              t.node.addEventListener(
                ...
                t.node.addEventListener(
                  "mouseenter",
                  this.dataLabelsMouseIn.bind(this, t.node, e)
                ),
                t.node.addEventListener(
                  "mouseleave",
                ...
                t.node.addEventListener(
                  "mouseleave",
                  this.dataLabelsMouseout.bind(this, t.node, e)
                ),
                t.node.addEventListener(
                  "mousedown",
              ...
              void 0 !== e.prevStartAngle &&
                ...
                e.i === i.config.series.length - 1 &&
                  (s + r > this.fullAngle
                    ...
                    : s + r < this.fullAngle &&
                      (e.endAngle = e.endAngle + (this.fullAngle - (s + r)))),
          ...
          },
          {
            ...
            value: function (t) {
              var e,
                i = this.w,
                s = this.size + 5,
                a = i.globals.dom.Paper.select("#apexcharts-pieSlice-" + t)
                  .members[0],
                n = a.attr("d");
              if ("true" !== a.attr("data:pieClicked")) {
                ...
                (e = this.getPiePath({
                  ...
                  360 !== l &&
                    a.plot(e).animate(1).plot(n).animate(100).plot(e);
              } else {
    ...
    I = (function () {
      function t(i) {
        ...
        (this.size =
          ...
          n.width / 1.75),
          void 0 !== s.config.plotOptions.radar.size &&
              ...
              if (
                ...
                t.forEach(function (t, r) {
                  var o = e.graphics
                    ...
                    .attr({
                      class: "apexcharts-series ".concat(
                        i.globals.seriesNames[r].toString().replace(/ /g, "-")
                      ),
                      rel: r + 1,
                      "data:realIndex": r,
                    });
                  ...
                  t.forEach(function (t, i) {
                    var s = new S(e.ctx).getMarkerConfig(
                        "apexcharts-marker",
                        r
                      ),
            ...
            value: function (t) {
              ...
              r.forEach(function (t, i) {
                ...
                s.forEach(function (t, s) {
                  ...
                  0 === s && e.yaxisLabelsTextsPos.push({ x: t.x, y: t.y }),
                    (a += t.x + "," + t.y + " ");
                }),
                  h.push(a);
              }),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              for (var o = 0; o < t.series.length; o++) {
                ...
                s.add(l),
                  l.attr({ id: "apexcharts-track-" + o, rel: o + 1 }),
            ...
            value: function (t) {
              ...
              for (
                ...
                var w = s.fillPath(y, { seriesNumber: v, size: t.size }),
                  ...
                  L =
                    Math.round((C * d.negToZero(t.series[v])) / 100) +
                    this.startAngle,
                  z = void 0;
                e.globals.dataChanged &&
                  ...
                  (z =
                    Math.round(
                      (C * d.negToZero(e.globals.previousPaths[v])) / 100
                    ) + S)),
                ...
                var X = new Y(this.ctx);
                y.add(E),
                  E.attr({ id: "apexcharts-radialArc-" + v, index: 0, j: v });
                var I = 0;
                !X.initialAnim ||
                  e.globals.resized ||
                  e.globals.dataChanged ||
            ...
            value: function (t, e, i) {
              ...
              for (
                ...
                s.globals.isXNumeric &&
                  (E = (s.globals.seriesX[k][0] - s.globals.minX) / g),
                  z.push(E);
                var X = void 0,
                  Y = void 0,
                  I = void 0,
                  ...
                  N = a.group({
                    class: "apexcharts-series ".concat(
                      s.globals.seriesNames[k].toString().replace(/ /g, "-")
                    ),
                  }),
                ...
                for (
                  ...
                  s.globals.isXNumeric
                    ? (E = (s.globals.seriesX[k][$ + 1] - s.globals.minX) / g)
                    : (E += w);
                  var J = d.isNumber(s.globals.minYArr[k])
                    ? s.globals.minYArr[k]
                    : s.globals.minY;
                ...
                m.push(C),
                  ...
                  this.pointsChart ||
                    s.globals.delayedElements.push({ el: R.node, index: k });
                var st = {
                  i: y,
                  realIndex: k,
                  animationDelay: y,
                ...
                if (s.config.stroke.show && !this.pointsChart) {
                  ...
                  at =
                    "line" === o
                      ? r.fillPath(N, { seriesNumber: k, i: y })
                ...
                if ("area" === o)
                  for (
                    var ot = r.fillPath(N, { seriesNumber: k }), lt = 0;
                    lt < D.length;
                    lt++
                  ) {
          ...
          },
          {
            ...
            value: function (t) {
              var e = t.series,
                ...
                p = this.w,
                x = new f(this.ctx),
                m = Array.isArray(p.config.stroke.curve)
                  ? p.config.stroke.curve[i]
                  : p.config.stroke.curve;
              if ("smooth" === m) {
                var b = 0.35 * (a - r);
                p.globals.hasNullValues
                  ? (null !== e[i][s] &&
                    ...
                    u.push(c),
                    g.push(d))
                  : ((c += x.curve(r + b, o, a - b, n, a, n)),
                    (d += x.curve(r + b, o, a - b, n, a, n))),
                  (r = a),
                  (o = n),
                  s === e[i].length - 2 &&
            ...
            value: function (t) {
              ...
              if (0 === r) {
                ...
                c.globals.isXNumeric &&
                  ...
                  u.push(f),
                  g.push(
                    d.isNumber(e[n][0]) ? o + c.config.markers.offsetY : null
                  ),
                  u.push(s + c.config.markers.offsetX),
                  g.push(
                    d.isNumber(e[n][r + 1])
                      ? a + c.config.markers.offsetY
                      : null
                  );
              } else
                u.push(s + c.config.markers.offsetX),
    ...
    D = (function () {
      function t(i) {
        e(this, t),
          ...
          (this.xAxisoffX = 0),
          "bottom" === this.w.config.xaxis.position &&
            ...
            value: function (t, e) {
              ...
              if (i.config.yaxis[e].labels.show)
                for (var u = l; u >= 0; u--) {
                  ...
                  g = d(g, u);
                  var p = 20;
                  i.config.yaxis[e].opposite && (p *= -1),
                    0 === i.config.yaxis.length && (p = 20);
                  var x = s.drawText({
                    x: p,
                    ...
                    cssClass:
                      ...
                      i.config.yaxis[e].labels.style.cssClass,
                  });
                  o.add(x);
                ...
                s
                  ...
                  : ((r =
                    ...
                    this.isBarHorizontal &&
                      ((o = 25),
                      (r =
                        -1 * e.width - a.config.yaxis[t].title.offsetX - o))),
                { xPos: r, padd: o }
              );
            },
          },
        ...
        s(t, [
          {
            ...
            value: function (t, e) {
              ...
              if (
                ...
                return new T(this.ctx).formatDate(
                  new Date(e),
                  i.config.tooltip.x.format,
                  !0,
                  !0
                );
              return t(e);
    ...
    R = (function () {
      function t(i) {
        ...
        (this.xaxisLabels = s.globals.labels.slice()),
          s.globals.timelineLabels.length > 0 &&
            (this.xaxisLabels = s.globals.timelineLabels.slice()),
          (this.drawnLabels = []),
          ...
          this.xaxisBorderWidth.indexOf("%") > -1
            ? (this.xaxisBorderWidth =
                (s.globals.gridWidth * parseInt(this.xaxisBorderWidth)) / 100)
              ...
              if (e.config.xaxis.labels.show)
                for (var d = 0; d <= c - 1; d++) {
                  ...
                  e.globals.timelineLabels.length > 0
                    ? ((p = e.globals.timelineLabels[d].position),
                      (g = e.globals.timelineLabels[d].value))
                    ...
                    (0 === (g = g.toString()).indexOf("NaN") ||
                      ...
                      (this.drawnLabels.indexOf(g) >= 0 &&
                        !e.config.xaxis.labels.showDuplicates)) &&
                      (g = ""),
        ...
        s(t, [
          {
            ...
            value: function (t, e) {
              ...
              if (
                void 0 === this.w.config.yaxis[0].max &&
                void 0 === this.w.config.yaxis[0].min
              )
                return { result: s, niceMin: s[0], niceMax: s[s.length - 1] };
              var g = t;
              (s = []).push(g);
              for (var f = Math.abs(e - t) / i, p = 0; p <= i - 1; p++)
                (g += f), s.push(g);
              return { result: s, niceMin: s[0], niceMax: s[s.length - 1] };
            },
          },
          ...
          },
          {
            ...
            value: function (t, e, i, s) {
              ...
              var u = h.map(function (t, s) {
                ...
                return (
                  Math.round(l / d.roundToBase(l, n)) * d.roundToBase(l, n)
                );
              });
              return (
                0 === u[0] && (u[0] = 1),
          ...
          },
          {
            ...
            value: function () {
              ...
              if (
                ...
                for (
                  var o = [], l = [], h = 0;
                  h < t.series[t.maxValsInArrayIndex].length;
                  h++
                )
              ...
              e.yaxis.map(function (e, s) {
                void 0 !== e.max &&
                  "number" == typeof e.max &&
                  ((t.maxYArr[s] = e.max), (t.maxY = i[0].max)),
                  void 0 !== e.min &&
                    "number" == typeof e.min &&
                    ((t.minYArr[s] = e.min), (t.minY = i[0].min));
              }),
                this.isBarHorizontal &&
                  (void 0 !== e.xaxis.min &&
        ...
        s(t, [
          ...
          },
          {
            ...
            value: function (t, e) {
              for (
                var i = this.w, s = 0;
                s < i.globals.collapsedSeries.length;
                s++
              )
                ...
                a(),
                  ...
                  (function (t) {
                    for (var e = 0; e < s.length; e++) {
                      ...
                      i >= t.from &&
                        i <= t.to &&
                        s[e].classList.remove("legend-mouseover-inactive");
                    }
          ...
          },
          {
            ...
            value: function () {
              ...
              var m = t.globals.dom.baseEl.querySelectorAll(
        ...
        s(t, [
          ...
          },
          {
            ...
            value: function (t, e) {
              var i = this.w;
              (this.xAxisHeight =
                (t.height + e.height) * i.globals.lineHeightRatio + 15),
            ...
            value: function () {
              ...
              if (e.globals.timelineLabels.length > 0) {
                ...
                (t = { width: l.width, height: l.height }).width * i.length >
                  e.globals.svgWidth - a - this.yAxisWidth &&
                0 !== e.config.xaxis.labels.rotate
                  ? this.isBarHorizontal ||
              ...
              return (
                e.config.yaxis.map(function (a, n) {
                  if (
                    ...
                    var l = new f(t.ctx).getTextRects(
                      o,
          ...
          },
          {
            ...
            value: function () {
              ...
              if (void 0 !== t.config.xaxis.title.text) {
                var s = new f(this.ctx).getTextRects(
        ...
        s(t, [
          {
            ...
            value: function (t, e) {
              ...
              if (s.globals.allSeriesCollapsed)
                return (
                  (s.globals.labels = []), (s.globals.timelineLabels = []), []
                );
        ...
        s(t, [
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              if (a.comboCharts) {
                if (
                  (r.series.length > 0 && p.push(c.draw(r.series, "area", r.i)),
                  l.series.length > 0)
                )
            ...
            value: function () {
              ...
              if (
                ("%" === s
                  ? d.isNumber(i[0]) &&
                    (0 === i[0].width &&
                      (i = d.getDimensions(this.el.parentNode)),
          ...
          },
          {
            ...
            value: function (t, e) {
              for (
                var i = this.w.config, s = this.w.globals, a = 0;
                a < t[e].data.length;
                a++
              )
                if (
                  (void 0 !== t[e].data[a][1] &&
                    (Array.isArray(t[e].data[a][1]) &&
                    4 === t[e].data[a][1].length
                ...
                o || l
                  ? o
                    ...
                    ? this.twoDSeriesX.push(
                        n.parseDate(t[e].data[r].x.toString())
                      )
                ...
                if (this.isMultiFormat())
                  this.isFormat2DArray()
                    ...
                    ("candlestick" !== s.chart.type &&
                      "candlestick" !== t[r].type) ||
                      this.handleCandleStickData(t, r),
                ...
                ("bar" === t && n.plotOptions.bar.horizontal
                  ...
                  : ((i = r.drawXaxis()),
                    ...
                    n.yaxis.map(function (t, i) {
                      -1 === a.ignoreYAxisIndexes.indexOf(i) &&
                        ((s = o.drawYaxis(e, i)), a.dom.Paper.add(s));
                    })));
                      ...
                      (n = a = r),
                        i.w.config.series.forEach(function (t) {
                          t.data.forEach(function (t) {
                            t[0] <= s.xaxis.max &&
                              t[0] >= s.xaxis.min &&
                              (t[1] > n && null !== t[1] && (n = t[1]),
                              t[1] < a && null !== t[1] && (a = t[1]));
                          });
                        }),
                        (a *= 0.95),
                        (n *= 1.05);
    ...
    at = (function () {
      function t(i) {
        ...
        (this.anim = new g(this.ctx)),
          (this.xaxisLabels = s.globals.labels.slice()),
          (this.animX =
            s.config.grid.xaxis.lines.animate &&
            s.config.chart.animations.enabled),
          (this.animY =
            s.config.grid.yaxis.lines.animate &&
            s.config.chart.animations.enabled),
          s.globals.timelineLabels.length > 0 &&
            (this.xaxisLabels = s.globals.timelineLabels.slice());
      }
          ...
          },
          {
            ...
            value: function () {
              for (
                ...
                (void 0 !== e.globals.yAxisScale[r] &&
                  (n = e.globals.yAxisScale[r].result.length - 1),
                !(n > 2));
                r++
              );
              if (
                ...
                if (
                  ...
                  e.config.grid.xaxis.lines.show ||
                    e.config.xaxis.axisTicks.show)
                )
                  for (
                    var o,
                      l = e.globals.padHorizontal,
                      h = e.globals.gridHeight,
                      c = 0;
                    c < t + 1 &&
                    ((o = l = l + e.globals.gridWidth / t + 0.3), c !== t - 1);
                    c++
                  ) {
                ...
                if (e.config.grid.yaxis.lines.show)
                  for (
                    var u = 0, g = 0, p = e.globals.gridWidth, x = 0;
                    x < e.globals.dataPoints + 1;
                    x++
                  ) {
                    var m = i.drawLine(
                      0,
                ...
                if (e.config.grid.yaxis.lines.show)
                  for (
                    var z = 0, M = 0, P = e.globals.gridWidth, E = 0;
                    E < n + 1;
                    E++
                  ) {
                    var T = i.drawLine(
              ...
              return (
                this.drawGridBands(a, t, n),
                { el: a, xAxisTickWidth: e.globals.gridWidth / t }
              );
            },
          },
          {
            ...
            value: function (t, e, i) {
              ...
              if (
                ...
                s.config.grid.row.colors.length > 0
              )
                for (
                  var n = 0,
                    r = s.globals.gridHeight / i,
              ...
              if (
                ...
                s.config.grid.column.colors.length > 0
              )
                for (
        ...
        s(t, [
          ...
          },
          {
            ...
            value: function () {
              ...
              for (
                var n = t.globals.legendFormatter, r = 0;
                r <= i.length - 1;
                r++
              ) {
                ...
                (y.background = s[r]),
                  (y.color = s[r]),
                  (y.height = Array.isArray(g)
                    ? parseFloat(g[r]) + "px"
                    : parseFloat(g) + "px"),
                  (y.width = Array.isArray(p)
                    ? parseFloat(p[r]) + "px"
                    : parseFloat(p) + "px"),
                  ...
                  (y.borderRadius = Array.isArray(b)
                    ? parseFloat(b[r]) + "px"
                    : parseFloat(b) + "px"),
            ...
            value: function (t, e) {
              ...
              (s.style.position = "absolute"),
                ...
                "bottom" === i.config.legend.position
                  ? ((s.style.top = "auto"),
                    (s.style.bottom = 10 + i.config.legend.offsetY + "px"))
                  : "right" === i.config.legend.position &&
                    ((s.style.left = "auto"),
                    (s.style.right = 25 + i.config.legend.offsetX + "px")),
                s.style.width &&
                  (s.style.width = parseInt(i.config.legend.width) + "px"),
                s.style.height &&
                  (s.style.height = parseInt(i.config.legend.height) + "px");
            },
          },
          {
          ...
          },
          {
            ...
            value: function () {
              ...
              if (
                (t.globals.axisCharts
                  ? t.globals.dom.baseEl
                      .querySelectorAll(".apexcharts-series[data\\:realIndex]")
                      .forEach(function (t) {
                        e.push(parseInt(t.getAttribute("data:realIndex")));
                      })
                  : t.globals.dom.baseEl
                      .querySelectorAll(".apexcharts-series[rel]")
                      .forEach(function (t) {
                ...
                for (
                  var i = t.globals.risingSeries.slice(),
                    s = t.config.series.slice(),
                    a = 0;
                  ...
                  -1 !== n &&
                    (t.globals.axisCharts
                      ? (s[n].data = t.globals.collapsedSeries
                          .slice()
                          [a].data.slice())
            ...
            value: function () {
              ...
              if (
                ...
                for (
                  ...
                  var h = void 0;
                  "dark" === r
                    ? ((h = e.shadeColor(-1 * o, a)), (o += n))
                    : ((h = e.shadeColor(o, a)), (o += n)),
                    i.push(h);
                }
            ...
            value: function (t) {
              ...
              n &&
                ...
                (g[0].parentNode.style.display =
                  null == h ? "none" : o.config.tooltip.items.display);
            },
          },
          {
            ...
            value: function (t) {
              ...
              return (
                void 0 !== s.config.tooltip.x.formatter &&
                  (n = s.globals.ttKeyFormatter(c, l)),
                s.globals.seriesZ.length > 0 &&
                  s.globals.seriesZ[0].length > 0 &&
                  (r = h(s.globals.seriesZ[e][i], s)),
                {
                  ...
                  xAxisTTVal:
                    "function" == typeof s.config.xaxis.tooltip.formatter
                      ? s.globals.xaxisTooltipFormatter(c, l)
                      : n,
                  zVal: r,
                }
              );
        ...
        s(t, [
          {
            ...
            value: function (t) {
              ...
              if (
                ...
                null !== a &&
                  (a.setAttribute("x", n), a.classList.add("active")),
                i.blxaxisTooltip)
              ) {
                var o = n;
                ("tickWidth" !== s.config.xaxis.crosshairs.width &&
          ...
          },
          {
            ...
            value: function (t) {
              var e = this.ttCtx;
              null !== e.ycrosshairs &&
                (f.setAttrs(e.ycrosshairs, { y1: t, y2: t }),
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              if (
                ...
                l > s.globals.gridWidth - r.ttWidth - 10 &&
                  (l = s.globals.gridWidth - r.ttWidth),
                l < -20 && (l = -20),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (
                ((e = s.e.clientY - o.top - s.tooltipRect.ttHeight / 2),
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              var s = e.getAttribute("cx"),
                a = e.getAttribute("cy");
              if (
                (this.tooltipPosition.moveXCrosshairs(s), !this.fixedTooltip)
              ) {
              ...
              if (
                ...
                (a = parseInt(d.getAttribute("j"))),
                  ...
                  s.globals.comboCharts &&
                    (r = parseInt(d.parentNode.getAttribute("data:realIndex"))),
                  n.tooltipLabels.drawSeriesTexts({
                    ttItems: i.ttItems,
                    i: r,
                    j: a,
                    ...
                    ? s.config.plotOptions.bar.horizontal
                      ? ((o = b - g.left + 15),
                        (l =
                          ...
                          f / 2 -
                          n.tooltipRect.ttHeight / 2))
                      : ((o = s.globals.isXNumeric
                          ? x - p / 2
                          : x - n.dataPointsDividedWidth + p / 2),
                        (l =
                          e.clientY - g.top - n.tooltipRect.ttHeight / 2 - 15))
                    : s.config.plotOptions.bar.horizontal
                    ? ((o = x) < n.xyRatios.baseLineInvertedY &&
                        (o = x - n.tooltipRect.ttWidth),
                      (l =
                        m -
                        n.dataPointsDividedHeight +
                        f / 2 -
    ...
    ft = (function () {
      function t(i) {
        ...
        (this.tooltipUtil = new lt(this)),
          ...
          (this.isBarShared =
            !s.config.plotOptions.bar.horizontal && s.config.tooltip.shared);
      }
      return (
        s(t, [
          {
                ...
                (this.dataPointsDividedHeight =
                  ...
                  this.showTooltipTitle &&
                    ...
                    (this.tooltipTitle.style.fontFamily =
                      e.config.tooltip.style.fontFamily ||
                      e.config.chart.fontFamily),
                    (this.tooltipTitle.style.fontSize =
                      e.config.tooltip.style.fontSize),
          ...
          },
          {
            ...
            value: function () {
              ...
              return (
                t.config.tooltip.fixed.position.toLowerCase().indexOf("right") >
                  -1 && (n = n + t.globals.svgWidth - s + 10),
                t.config.tooltip.fixed.position
                  .toLowerCase()
                  .indexOf("bottom") > -1 &&
              ...
              for (
                var i = this,
                  ...
                  a = function (a) {
                    ...
                    ["mousemove", "touchmove", "mouseout", "touchend"].map(
                      function (e) {
                        return t[a].addEventListener(
                          e,
                          s.seriesHover.bind(s, n),
                          { capture: !1, passive: !0 }
                        );
                      }
                    );
                ...
                if (
                  ...
                  if (null !== g) {
                    ...
                    void 0 !== r.globals.series[g][e]
                      ...
                      : this.tooltipUtil.isXoverlap(e) &&
                        this.create(this, 0, e, n.ttItems);
                  } else
                    this.tooltipUtil.isXoverlap(e) &&
                      this.create(this, 0, e, n.ttItems);
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if ("mousemove" === e.type || "touchmove" === e.type) {
                ...
                u < 0
                  ? (u = 0)
                  : u + s.ttWidth > a.globals.gridWidth &&
                    (u = c - d.left - s.ttWidth + o),
                  g < 0 && (g = s.ttHeight + 20),
            ...
            value: function (t, e, i, s) {
              ...
              if (a) {
                ...
                r.tooltipLabels.drawSeriesTexts({
                  ...
                  this.hasBars() &&
                    r.tooltipPosition.moveStickyTooltipOverBars(i),
        ...
        s(t, [
          {
            ...
            value: function () {
              ...
              e.appendChild(this.elMenu),
                f.setAttrs(this.elMenu, { class: "apexcharts-menu" });
              for (
                var a = [
          ...
          },
          {
            ...
            value: function () {
              this.elZoomReset &&
                ...
                this.elZoomIn.removeEventListener(
                  "click",
                  this.handleZoomIn.bind(this)
                ),
                this.elZoomOut.removeEventListener(
                  "click",
                  this.handleZoomOut.bind(this)
                ),
                this.elPan.removeEventListener(
                  "click",
                  this.togglePanning.bind(this)
                ),
                this.elMenuIcon.removeEventListener(
                  "click",
                  this.toggleMenu.bind(this)
                )),
                (this.elZoom = null),
        ...
        s(i, [
          {
            ...
            value: function (t) {
              ...
              (this.xyRatios = i),
                ...
                (this.gridRect =
                  s.globals.dom.baseEl.querySelector(".apexcharts-grid")),
          ...
          },
          {
            ...
            value: function () {
              ...
              this.eventList.forEach(function (i) {
                t.hoverArea &&
                  t.hoverArea.removeEventListener(
                    i,
                    e.svgMouseEvents.bind(e, e.xyRatios),
                    { capture: !1, passive: !0 }
                  );
              }),
          ...
          },
          {
            ...
            value: function (t) {
              var e = t.context,
                ...
                u = {};
              return (
                (Math.abs(l + r) > s.globals.gridWidth ||
                  a.clientX - n.left < 0) &&
                  (a.hideSelectionRect(this.zoomRect),
                  (a.dragged = !1),
            ...
            value: function (t) {
              ...
              if (
                ...
                if (s.globals.zoomEnabled) {
                  ...
                  s.globals.zoomed ||
                    ((s.globals.lastXAxis = d.clone(s.config.xaxis)),
                  ...
                  if (
                    ...
                    x &&
                      ((p = x.xaxis ? x.xaxis : p), (f = x.yaxis ? x.yaxe : f));
                  }
                  "x" === i
  ...
  (et = "undefined" != typeof window ? window : void 0),
    (it = function (e, i) {
      var s = ((void 0 !== this ? this : e).SVG = function (t) {
        if (s.supported)
          return (t = new s.Doc(t)), s.parser.draw || s.prepare(), t;
      });
      if (
      ...
      (s.did = 1e3),
        ...
        (s.extend = function () {
          var t, e, i, a;
          for (
            e = (t = [].slice.call(arguments)).pop(), a = t.length - 1;
            a >= 0;
            a--
          )
        ...
        (s.prepare = function () {
          var t = i.getElementsByTagName("body")[0],
            e = (t ? new s.Doc(t) : s.adopt(i.documentElement).nested()).size(
              2,
              0
            );
          s.parser = {
        ...
        s.extend(s.PointArray, {
          ...
          size: function (t, e) {
            ...
            for (i = this.value.length - 1; i >= 0; i--)
              s.width &&
                (this.value[i][0] =
                  ((this.value[i][0] - s.x) * t) / s.width + s.x),
                s.height &&
                  (this.value[i][1] =
      ...
      (s.PathArray = function (t, e) {
          ...
          size: function (t, e) {
            ...
            for (i = this.value.length - 1; i >= 0; i--)
              "M" == (s = this.value[i][0]) || "L" == s || "T" == s
                ? ((this.value[i][1] =
                    ((this.value[i][1] - a.x) * t) / a.width + a.x),
                  (this.value[i][2] =
                    ((this.value[i][2] - a.y) * e) / a.height + a.y))
                : "H" == s
                ? (this.value[i][1] =
                    ((this.value[i][1] - a.x) * t) / a.width + a.x)
                : "V" == s
                ...
                ? ((this.value[i][1] =
                  ...
                  (this.value[i][2] =
                    ((this.value[i][2] - a.y) * e) / a.height + a.y),
                  (this.value[i][3] =
                    ((this.value[i][3] - a.x) * t) / a.width + a.x),
                  (this.value[i][4] =
                    ((this.value[i][4] - a.y) * e) / a.height + a.y),
                  "C" == s &&
                    ((this.value[i][5] =
                      ((this.value[i][5] - a.x) * t) / a.width + a.x),
                    (this.value[i][6] =
                      ((this.value[i][6] - a.y) * e) / a.height + a.y)))
                : "A" == s &&
                  ((this.value[i][1] = (this.value[i][1] * t) / a.width),
                  (this.value[i][2] = (this.value[i][2] * e) / a.height),
                  (this.value[i][6] =
                    ((this.value[i][6] - a.x) * t) / a.width + a.x),
                  (this.value[i][7] =
                    ((this.value[i][7] - a.y) * e) / a.height + a.y));
            return this;
          },
        ...
        (s.Number = s.invent({
          ...
          extend: {
            ...
            morph: function (t) {
              return (
                (this.destination = new s.Number(t)),
            ...
            at: function (t) {
              return this.destination
                ? new s.Number(this.destination).minus(this).times(t).plus(this)
                : this;
            },
          },
        })),
        (s.Element = s.invent({
          ...
          extend: {
            ...
            size: function (t, e) {
              var i = g(this, t, e);
              return this.width(new s.Number(i.width)).height(
                new s.Number(i.height)
              );
            },
            clone: function (t) {
              this.writeDataToDom();
        ...
        (s.FX = s.invent({
          ...
          extend: {
            ...
            target: function (t) {
              return t && t instanceof s.Element
                ? ((this._target = t), this)
                : this._target;
            },
            ...
            queue: function (t) {
              return (
                ("function" == typeof t || t instanceof s.Situation) &&
            ...
            initAnimations: function () {
              ...
              for (t in a.animations)
                for (
                  i = this.target()[t](),
                    Array.isArray(i) || (i = [i]),
                    Array.isArray(a.animations[t]) ||
                      (a.animations[t] = [a.animations[t]]),
                    e = i.length;
                  e--;

                )
                  a.animations[t][e] instanceof s.Number &&
                    (i[e] = new s.Number(i[e])),
                    (a.animations[t][e] = i[e].morph(a.animations[t][e]));
              for (t in a.attrs)
                a.attrs[t] = new s.MorphObj(this.target().attr(t), a.attrs[t]);
              for (t in a.styles)
                a.styles[t] = new s.MorphObj(
                  this.target().style(t),
                  a.styles[t]
                );
              return (
                (a.initialTransformation = this.target().matrixify()),
                (a.init = !0),
                this
              );
            },
            ...
            step: function (t) {
                ...
                ? ((e = Math.max(this.absPos, 0)),
                  ...
                  this.situation.reversing &&
                    (this.situation.reversed =
                      this.situation.reversed !=
                      Boolean((this.situation.loop - s) % 2)))
              ...
              for (var n in this.situation.once)
                n > this.lastPos &&
                  n <= a &&
                  (this.situation.once[n].call(this.target(), this.pos, a),
              ...
              if (r.transforms.length) {
                for (
                  ...
                  o instanceof s.Matrix
                    ? (i = o.relative
                        ? i.multiply(
                            new s.Matrix().morph(o).at(r.ease(this.pos))
                          )
        ...
        s.extend(s.FX, {
          ...
          size: function (t, e) {
            ...
            this.target() instanceof s.Text
              ...
              : ((t && e) || (i = this.target().bbox()),
                ...
                this.add("width", new s.Number(t)).add(
                  "height",
                  new s.Number(e)
                ));
            return this;
          ...
          leading: function (t) {
            return this.target().leading
              ? this.add("leading", new s.Number(t))
              : this;
          },
          viewbox: function (t, e, i, a) {
            return (
              this.target() instanceof s.Container &&
                this.add("viewbox", new s.ViewBox(t, e, i, a)),
              this
            );
          },
          update: function (t) {
        ...
        (s.Box = s.invent({
          create: function (e, i, a, n) {
            ...
            4 == arguments.length &&
              ((this.x = e), (this.y = i), (this.width = a), (this.height = n)),
              b(this);
          },
          extend: {
            merge: function (t) {
        ...
        (s.RBox = s.invent({
          create: function (t) {
            s.Box.apply(this, [].slice.call(arguments)),
              t instanceof s.Element &&
                s.Box.call(this, t.node.getBoundingClientRect());
          },
          inherit: s.Box,
          parent: s.Element,
          extend: {
          ...
          construct: {
            rbox: function (t) {
              return t
                ? new s.RBox(this).transform(t.screenCTM().inverse())
                : new s.RBox(this).addOffset();
            },
          },
        })),
        ...
        (s.Matrix = s.invent({
          ...
          extend: {
            ...
            skew: function (t, e, i, a) {
              return (
                ...
                this.around(
                  i,
                  a,
                  new s.Matrix(1, Math.tan(e), Math.tan(t), 1, 0, 0)
                )
              );
            },
            ...
            native: function () {
              for (
                var t = s.parser.native.createSVGMatrix(), e = y.length - 1;
                e >= 0;
                e--
              )
                t[y[e]] = this[y[e]];
          ...
          attr: function (e, i, a) {
            if (null == e) {
              for (
                ...
                e[i[a].nodeName] = s.regex.isNumber.test(i[a].nodeValue)
        ...
        s.extend(s.Element, {
          transform: function (e, i) {
            ...
            if ("object" !== t(e))
              return (
                (a = new s.Matrix(this).extract()),
                "string" == typeof e ? a[e] : a
              );
            if (
              ((a = new s.Matrix(this)), (i = !!i || !!e.relative), null != e.a)
            )
              a = i ? a.multiply(new s.Matrix(e)) : new s.Matrix(e);
            else if (null != e.rotation)
              x(e, this),
                (a = i
                  ? a.rotate(e.rotation, e.cx, e.cy)
                  : a.rotate(e.rotation - a.extract().rotation, e.cx, e.cy));
              ...
              if (
                ...
                r = a.extract();
                a = a.multiply(
                  new s.Matrix().skew(r.skewX, r.skewY, e.cx, e.cy).inverse()
                );
              }
              ...
              e.flip
                ...
                : (null == e.x && null == e.y) ||
                  (i
                    ? (a = a.translate(e.x, e.y))
                    : (null != e.x && (a.e = e.x), null != e.y && (a.f = e.y)));
        ...
        (s.Transformation = s.invent({
          create: function (e, i) {
            ...
            if (Array.isArray(e))
              ...
              for (s = 0, a = this.arguments.length; s < a; ++s)
          ...
          extend: {
            ...
            at: function (t) {
              ...
              return (
                (n = new s.Matrix()
                  .morph(s.Matrix.prototype[this.method].apply(n, e))
                  .at(t)),
        ...
        s.extend(s.Element, {
          style: function (e, i) {
            ...
            if (arguments.length < 2)
              ...
              this.node.style[c(e)] =
                null === i || s.regex.isBlank.test(i) ? "" : i;
            return this;
          },
        }),
        (s.Parent = s.invent({
        ...
        s.extend(s.Parent, {
          ungroup: function (t, e) {
            return 0 === e ||
              ...
              ? this
              : ((t =
                  t || (this instanceof s.Doc ? this : this.parent(s.Parent))),
                (e = e || 1 / 0),
                this.each(function () {
          ...
          construct: {
            viewbox: function (t, e, i, a) {
              return 0 == arguments.length
                ? new s.ViewBox(this)
                : this.attr("viewBox", new s.ViewBox(t, e, i, a));
            },
          },
        })),
        [
        ...
        (s.off = function (t, e, i) {
          ...
          if (-1 != a)
            if (i) {
              ...
              s.listeners[a][n] &&
                s.listeners[a][n][r || "*"] &&
                (t.removeEventListener(n, s.listeners[a][n][r || "*"][i], !1),
            ...
            return (
              t instanceof e.Event
                ...
                : this.node.dispatchEvent(
                    (t = new s.CustomEvent(t, { detail: i, cancelable: !0 }))
                  ),
              (this._event = t),
              this
            );
        ...
        (s.Mask = s.invent({
          ...
          extend: {
            remove: function () {
              ...
              return (
                (this.targets = []), s.Element.prototype.remove.call(this), this
              );
            },
          },
          construct: {
        ...
        s.extend(s.Element, {
          maskWith: function (t) {
            return (
              (this.masker =
                t instanceof s.Mask ? t : this.parent().mask().add(t)),
        ...
        s.extend(s.Element, {
          clipWith: function (t) {
            return (
              (this.clipper =
                t instanceof s.ClipPath ? t : this.parent().clip().add(t)),
        ...
        s.extend(s.Circle, s.Ellipse, {
          ...
          width: function (t) {
            return null == t
              ? 2 * this.rx()
              : this.rx(new s.Number(t).divide(2));
          },
          height: function (t) {
            return null == t
              ? 2 * this.ry()
              : this.ry(new s.Number(t).divide(2));
          },
          size: function (t, e) {
            var i = g(this, t, e);
            return this.rx(new s.Number(i.width).divide(2)).ry(
              new s.Number(i.height).divide(2)
            );
          },
        }),
        (s.Line = s.invent({
        ...
        s.extend(s.Polyline, s.Polygon, {
          ...
          plot: function (t) {
            return null == t
              ...
              : this.clear().attr(
                  "points",
                  "string" == typeof t ? t : (this._array = new s.PointArray(t))
                );
          },
          clear: function () {
        ...
        (s.Text = s.invent({
          ...
          extend: {
            ...
            leading: function (t) {
              return null == t
                ? this.dom.leading
                : ((this.dom.leading = new s.Number(t)), this.rebuild());
            },
            lines: function () {
              var t = ((this.textPath && this.textPath()) || this).node,
                e = s.utils.map(
                  s.utils.filterSVGElements(t.childNodes),
                  function (t) {
                    return s.adopt(t);
                  }
                );
        ...
        (s.TextPath = s.invent({
          ...
          construct: {
            ...
            path: function (t) {
              for (
                var e = new s.TextPath(), i = this.doc().defs().path(t);
        ...
        s.extend(s.Line, s.Polyline, s.Polygon, s.Path, {
          marker: function (t, e, i, a) {
            ...
            return (
              ...
              (n = n.join("-")),
              (t =
                arguments[1] instanceof s.Marker
                  ? arguments[1]
                  : this.doc().marker(e, i, a)),
              this.attr(n, t)
            );
          },
        });
      ...
      function g(t, e, i) {
        if (null == e || null == i) {
          var s = t.bbox();
          null == e
            ? (e = (s.width / s.height) * i)
            : null == i && (i = (s.height / s.width) * e);
        }
        return { width: e, height: i };
      }
      function f(t, e, i) {
      ...
      ["fill", "stroke"].forEach(function (t) {
        ...
        s.extend(s.Element, s.FX, {
          ...
          matrix: function (t) {
            return this.attr(
              "transform",
              new s.Matrix(6 == arguments.length ? [].slice.call(arguments) : t)
            );
          },
          opacity: function (t) {
          ...
          dx: function (t) {
            return this.x(
              new s.Number(t).plus(this instanceof s.FX ? 0 : this.x()),
              !0
            );
          },
          dy: function (t) {
            return this.y(
              new s.Number(t).plus(this instanceof s.FX ? 0 : this.y()),
              !0
            );
          },
          dmove: function (t, e) {
        ...
        (s.Set.inherit = function () {
          ...
          for (var e in s.Shape.prototype)
            "function" == typeof s.Shape.prototype[e] &&
              "function" != typeof s.Set.prototype[e] &&
              t.push(e);
          ...
          (t = []),
          s.FX.prototype))
            "function" == typeof s.FX.prototype[e] &&
              "function" != typeof s.FX.Set.prototype[e] &&
              t.push(e);
          t.forEach(function (t) {
          ...
          data: function (e, i, s) {
            if ("object" === t(e)) for (i in e) this.data(i, e[i]);
              ...
              this.attr(
                ...
                null === i
                  ? null
                  : !0 === s || "string" == typeof i || "number" == typeof i
                  ? i
                  : JSON.stringify(i)
              );
            return this;
      ...
      return (
        (function (t) {
          for (
            var i = 0, s = ["moz", "webkit"], a = 0;
            a < s.length && !e.requestAnimationFrame;
            ++a
          )
            (t.requestAnimationFrame = t[s[a] + "RequestAnimationFrame"]),
              (t.cancelAnimationFrame =
                t[s[a] + "CancelAnimationFrame"] ||
                t[s[a] + "CancelRequestAnimationFrame"]);
    ...
    function () {
      ...
      var t = {
        ...
        specularLighting: function (t, e, i, s) {
          return (
            this.parent() && this.parent().specularLighting(t, e, i, s).in(this)
          );
        },
        tile: function () {
    ...
    (function () {
        ...
        switch (t[0]) {
          ...
          case "A":
            t = (e = (function (t, e) {
              ...
              (i = new SVG.Point((F.x - O.x) / 2, (F.y - O.y) / 2).transform(
                new SVG.Matrix().rotate(E)
              )),
                (s = (i.x * i.x) / (M * M) + (i.y * i.y) / (P * P)) > 1 &&
                  ((s = Math.sqrt(s)), (M *= s), (P *= s));
              (a = new SVG.Matrix()
                .rotate(E)
                .scale(1 / M, 1 / P)
                .rotate(-E)),
      ...
      SVG.extend(SVG.PathArray, {
        morph: function (e) {
          for (
            var i = this.value, s = this.parse(e), n = 0, r = 0, o = !1, l = !1;
            !1 !== n || !1 !== r;
        ...
        (t.prototype.drag = function (t) {
          var e = this.getBBox(),
            ...
            l = new CustomEvent("dragmove", {
              detail: { event: t, p: i, m: this.m, handler: this },
              cancelable: !0,
            });
    ...
    (function () {
      ...
      (t.prototype.init = function (t, e) {
        ...
        (t.prototype.drawCircles = function () {
          for (
            var t = this, e = this.getPointArray(), i = 0, s = e.length;
            i < s;
            ++i
          ) {
            var a = (function (e) {
      ...
      (function () {
        ...
        (t.prototype.transformPoint = function (t, e, i) {
          ...
          (t.prototype.checkAspectRatio = function (t) {
            ...
            return (
              n < i
                ? (e[1] = s / i - this.parameters.box.height)
                : n > i && (e[0] = this.parameters.box.width - a * i),
              e
            );
          }),
          SVG.extend(SVG.Element, {
        ...
        (function (t) {
          if ("Element" in t) {
            var e = t.Element.prototype,
              ...
              o = function (t) {
                for (
                  var e = s.call(t.getAttribute("class") || ""),
                    i = e ? e.split(/\s+/) : [],
                    a = 0,
                    n = i.length;
                  a < n;
    ...
    (function () {
      ...
      (window.addResizeListener = function (s, a) {
        s.__resizeTriggers__ ||
          ...
          ((s.__resizeTriggers__ = document.createElement("div")).className =
            "resize-triggers"),
          ...
          [
            ...
            },
            {
              ...
              value: function (t, e) {
                ...
                if (i.globals.events.hasOwnProperty(t)) {
                  (e && e.length) || (e = []);
                  for (
                    var s = i.globals.events[t], a = s.length, n = 0;
                    n < a;
                    n++
                  )
                    s[n].apply(null, e);
            ...
            },
            {
              ...
              value: function (t) {
                ...
                return (
                  ...
                  t.xaxis &&
                    (t.xaxis.min || t.xaxis.max) &&
                    this.forceXAxisUpdate(t),
              ...
              value: function () {
                var t =
                  ...
                  i =
                    ...
                    arguments[2];
                return (
                  this.revertDefaultAxisMinMax(), this._updateSeries(t, e, i)
                );
              },
            },
            {
              ...
              value: function (t, e) {
                ...
                return (
                  ...
                  a.globals.allSeriesCollapsed &&
                    (a.globals.allSeriesCollapsed = !1),
                  ...
                  s &&
                    ((a.globals.initialConfig.series = JSON.parse(
                      JSON.stringify(a.config.series)
                    )),
                    (a.globals.initialSeries = JSON.parse(
                      JSON.stringify(a.config.series)
                    ))),
                  this.update()
                );
            ...
            },
            {
              ...
              value: function (t) {
                ...
                for (
                  var s = i.w.config.series.slice(), a = 0;
                  a < s.length;
                  a++
                )
                  if (void 0 !== t[a])
                ...
                (t.config.xaxis.min = t.globals.lastXAxis.min),
                  ...
                  t.config.yaxis.map(function (e, i) {
                    t.globals.zoomed &&
                      ...
                      ((e.min = t.globals.lastYAxis[i].min),
                  ...
                  i.addEventListener(
                    ...
                    function (i) {
                      ("mousedown" === i.type && 1 === i.which) ||
                        ((("mouseup" === i.type && 1 === i.which) ||
                          "touchend" === i.type) &&
                          ("function" == typeof t.config.chart.events.click &&
                            t.config.chart.events.click(i, e, t),
